...
Source: https://developers.webexconnect.io/reference/sandbox-post_v1-voice-messages
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:31:40+00:00

> 📘 Note:
> 
> New Sandbox API endpoint: <https://api.us.webexconnect.io/v1/voice/messages>
...
```json
{
  ...
  "operation": {
    ...
    "summary": "Place a new call, play an audio and disconnect i.e. play and drop",
    "parameters": [
      {
    ...
    "requestBody": {
      "content": {
        "application/json": {
          "schema": {
            "$ref": "#/components/schemas/NewVoiceMessage"
          }
        }
      }
    },
