...
Source: https://developers.webexconnect.io/reference/faqs-miscellaneous
...
Webex Connect can be accessed using the latest versions of Chrome, Mozilla, and Safari.
