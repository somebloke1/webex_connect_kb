...
> 
> - The format of the endpoint is: https\://{tenantName}.{yourRegion}.webexconnect.io/connectapi/v1/auditlogs
> 
> - You will have to use Cisco Webex Common Identity (CI) token (Refer to [Webex Contact Center Authentication](https://developer.webex.com/webex-contact-center/docs/authentication) for token generation).

The <<prodname>> User Audit Logs API enables tenants to securely retrieve their Audit Logs on demand through a simple, authenticated API call. Designed to enhance operational flexibility and support compliance requirements, this API provides an alternative to Kafka-based log delivery, allowing users to access audit data whenever needed, without dependency on streaming infrastructure.
...
[block:parameters]
{
  "data": {
    ...
    "0-1": "String/Num",
    "0-2": "yes",
    "0-3": "Time range (e.g., 6 represents the last 6 days and today). Range can be used in two ways - Numeric Value or Custom Range. Numeric Value: To select a predefined number of days. The value represents the number of days, starting from 0.  \n0 = Yesterday  \n1 = Today  \n6 = Last 6 days and today  \nCustom Range: To select a specific date range. Use \"range\": \"custom\" and specify both 'from' Date and 'to' Date in ISO 8601 format. Note: If 'custom' is selected, both 'from' and 'to' dates are mandatory.",
    "1-0": "from",
    "1-1": "String",
    "1-2": "yes",
    "1-3": "Start timestamp for the Audit Logs fetch (ISO 8601 format). Example: \"2018-01-01T13:12:11.789Z\"",
    "2-0": "to",
    "2-1": "String",
    "2-2": "yes",
    "2-3": "End timestamp for the Audit Logs fetch (ISO 8601 format). Example: \"2018-01-01T14:12:11.789Z\"",
    "3-0": "offset",
    "3-1": "Integer",
    "3-2": "no",
    "3-3": "The starting record index for the retrieval range with default 0.",
    "4-0": "max  ",
    "4-1": "Integer ",
    "4-2": "no  ",
    "4-3": "Limit the maximum number of records to be returned in the response. The maximum value is 10,000 and the default value is 2000. \"Max\": 100",
    "5-0": "eventCategories ",
    "5-1": "String ",
    "5-2": "no  ",
    "5-3": "Comma-separated list of event categories to filter logs. Refer [Event Categories](https://developers.webexconnect.io/reference/data-streams-audit-logs#user-actions) for Audit Logs.",
    "6-0": "actorIds ",
    "6-1": "String ",
    "6-2": "no  ",
    "6-3": "Comma-separated list of user IDs to filter logs.",
    "7-0": "adminRoles ",
    "7-1": "String ",
    "7-2": "no  ",
    "7-3": "Comma-separated list of admin roles to filter logs."
  },
  "cols": 4,
  "rows": 8,
  "align": [
    ...
    "auditLogs": [
        {
            ...
            "actorEmail": "garuda+cloudqa@cisco.com",
            "serviceId": "0",
