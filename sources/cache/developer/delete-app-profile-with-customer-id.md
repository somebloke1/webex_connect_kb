# Delete App Profile with Customer ID

Source: https://developers.webexconnect.io/reference/delete-app-profile-with-customer-id
...
{
  "method": "delete",
  "url": "/customerappprofile/inappid?customerId=customerId",
  "auth": "required",
  "params": [
    {
      "name": "appid",
  ...
  "examples": {
    "codes": [
      {
        "code": "-X DELETE http://api.imiconnect.io/resources/v2/customerappprofile/{{inappid}}?customerId={customerId}\\\n-H \"Content-Type : application/json\"\n-H \"key : {profilekey}\"\n",
        "language": "curl"
      },
      {
...
```json
{
  ...
  "path": "/customerappprofile/inappid?customerId=customerId",
  "method": "delete",
  "path_parameters": [],
  "operation": {
    "summary": "Delete App Profile with Customer ID",
    "description": "This API is used to delete application profile of a customer.",
    "operationId": "delete-app-profile-with-customer-id",
    "parameters": [
      {
        "name": "appid",
        "in": "path",
