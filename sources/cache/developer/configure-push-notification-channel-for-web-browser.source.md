...
To add a web application in <<prodname>>, follow these steps:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/908c979-Push5.jpeg",
        "",
        "Screenshot of Configure Chrome and Firefox Push Notifications"
      ],
      "align": "center",
      "border": true,
      "caption": "Configure Chrome and Firefox Push Notifications"
    }
  ]
}
[/block]
...
3. Enter the following fields to configure Safari browser:
   ...
   2. Site URL: The URL that is used to validate the identity of the website requesting push notifications using your ID. Only the website that matches the URL can use your <<prodname>> ID for push notifications.
   3. Notification Icons: It is mandatory to upload all five icons. Click the respective buttons to upload the icons.
   4. APNS Credentials: Enter the password that is set while generating the certificate in the section  **[Setup APNS for Safari Browser](doc:setup-apns-for-safari-browser)**. Leave this field blank if the certificate was generated without a password.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5073cbc-web_app_safari.png",
        "web_app_safari.png",
        "Screenshot of Configure Safari Push Notifications."
      ],
      "align": "center",
      "border": true,
      "caption": "Configure Safari Push Notification"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4a0175506c05a44f0c0537a3373bb10cc9f7e92787a704a99d416565383d18d4-image.png",
        null,
        null
      ],
      "align": "center",
