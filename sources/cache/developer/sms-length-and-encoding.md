...
Source: https://developers.webexconnect.io/reference/sms-length-and-encoding
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:31:41+00:00

## Background - GSM Encoding

The most commonly used encoding for SMS is the [GSM-7 (Global System for Mobile Communications) character set defined by the GSM 03.38 standard](https://en.wikipedia.org/wiki/GSM_03.38#GSM_7-bit_default_alphabet_and_extension_table_of_3GPP_TS_23.038_.2F_GSM_03.38).
...
> 📘 Note
> 
> Webex Connect supports SMS message content up to 4000 characters. We recommend that you keep SMS messages below 450 characters for better deliverability and user experience.
> 
> Please refer to the [Messaging API v2 ](https://developers.imiconnect.io/reference/messagesv2)chapter as it is recommended version of the SMS API.
