...
Source: https://developers.webexconnect.io/reference/retrieve-message-v2
  ...
  "params": [
    {
      ...
      "in": "header",
      "ref": "",
      "_id": "60996bde45fabd028a644bcb",
      "id": "60996bde45fabd028a644bcb"
    },
    {
      "name": "key",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "60996bde45fabd028a644bca",
      "id": "60996bde45fabd028a644bca"
    },
    {
      "name": "Authorization",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "60996bde45fabd028a644bc9",
      "id": "60996bde45fabd028a644bc9"
    }
  ],
  "apiSetting": "6a675233ec1c893d8a7f67b7",
  "examples": {
    "codes": []
  }
}
...
```json
{
  ...
  "path_parameters": [],
  "operation": {
    "summary": "Get Message v2",
    "description": "",
    "operationId": "retrieve-message-v2",
    "parameters": [
      {
        "name": "Content-Type",
        "in": "header",
          ...
          "application/json": {
            ...
            "schema": {
              ...
              "properties": {
                ...
                "requestTimestamp": {
                  "type": "string",
                  "example": "2020-04-09T09:46:37.897Z"
                },
                "groupId": {
                  "type": "integer",
                  "example": 1387,
                ...
                "messageId": {
                  "type": "string",
                  "example": "6173724b-c850-42b0-b9d7-eac73de28e95"
                },
                "requestedReceipts": {
                  "type": "array",
                  "items": {
                ...
                "options": {
                  ...
                  "properties": {
                    ...
                    "domain": {
                      "type": "string",
                      "example": "https://sstg.imiconnect.net"
                    },
                    "trackClicks": {
                      "type": "boolean",
                      "example": true,
                ...
                "notifyUrl": {
                  "type": "string",
                  "example": "https://webhook.site/f6fbab37-6d59-4fec-913a-021db78ce43b"
                },
                "from": {
                  "type": "string",
                  "example": "CONNCT"
