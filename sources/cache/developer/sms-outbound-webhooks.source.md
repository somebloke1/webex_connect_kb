...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "timeStamp",
    "0-1": "Timestamp of the event",
    "1-0": "description",
    "1-1": "Detailed description of the delivery status.",
    "2-0": "code",
    "2-1": "Status code as mentioned in the documentation",
    "3-0": "messageCount",
    "3-1": " The number of segments in the SMS message. This value will only be returned for Delivered and Failed delivery receipts. _Note: This field will not be available in Canada and India regions_",
    "4-0": "deliveryChannel",
    "4-1": "Channel to be used to send message",
    "5-0": "destination",
    "5-1": "The mobile number to which message will be sent",
    "6-0": "destinationType",
    "6-1": "This is always msisdn for SMS",
    "7-0": "additionalinfo",
    "7-1": "Additional info such as details about the browser used to open a link in case of Click events. Please note that Clicked events are tracked only when using shortenLinks with trackClicks set to true via Messaging API v2. Click tracking isn't available for Smart Links at the moment.",
    "8-0": "deliveryStatus",
    "8-1": "Status of messages once sent",
    "9-0": "carrier",
    "9-1": "A unique identifier for the carrier. See [SMS Carrier Mapping](https://developers.webexconnect.io/reference/sms-carrier-mapping) for the mapping to the carrier name and country ISO code.  \n**Note**: The `carrier` field contains the carrier ID where available.",
    "10-0": "subtid",
    "10-1": "A unique transaction id will be generated as subtid for the flow level transactions(or node tid)",
    "11-0": "transid",
    "11-1": "Unique transaction reference id of the request",
    "12-0": "callbackData",
    "12-1": "Data that you have configured to receive on the notify Url. This is configured as a part of the request",
    "13-0": "correlationid",
    "13-1": "The CorrelationID is a unique identifier that you can attach to every request as a reference a particular transaction or event. This is configured as a part of the request.",
    "14-0": "Submitted",
    "14-1": "When a message is submitted to the <<prodname>> gateway",
    "15-0": "Delivered",
    "15-1": "Returned when the delivery is completed successfully",
    "16-0": "Un-Delivered",
    "16-1": "We have different reasons for the un-delivered in the document",
    "17-0": "Failed",
    "17-1": "We have multiple reasons for the failure of a message  \nEg: When the sender ID is invalid.  \nWhen the address is invalid more details and error codes are already covered in the document"
  },
  "cols": 2,
  "rows": 18,
  "align": [
...
Once done, you'll be notified on the configured URL whenever an incoming message is received on the configured <<prodname>> phone number/short code.
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Descriptions",
    "0-0": "channel",
    "0-1": "Channel is SMS always for incoming SMS",
    "1-0": "oa",
    "1-1": "Phone number on which the SMS has been received on",
    "2-0": "da",
    "2-1": "End user phone number from which the message was sent from",
    "3-0": "message_source",
    "3-1": "Message type",
    "4-0": "message",
    "4-1": "Message content",
    "5-0": "messageCount",
    "5-1": "The number of segments in the incoming SMS message.",
    "6-0": "tid",
    "6-1": "Unique transaction reference id of the request",
    "7-0": "datetime",
    "7-1": "Timestamp when this message was received on <<prodname>>",
    "8-0": "ts",
    "8-1": "Timestamp when this message was received on <<prodname>>",
    "9-0": "x_networkid",
    "9-1": "A unique identifier for the carrier. See [SMS Carrier Mapping](https://developers.webexconnect.io/reference/sms-carrier-mapping)  for the mapping to the carrier name and country ISO code.  \n**Note**: The `x_networkid` field contains the carrier ID where available."
  },
  "cols": 2,
  "rows": 10,
  "align": [
