...
Source: https://developers.webexconnect.io/reference/segment-apis-overview
...
> 📘 JWT Authentication
> 
> Webex Connect allows using JWT Authentication for the [Thread APIs](https://developers.imiconnect.io/reference#overview-of-thread-apis), Segment APIs, and [Topic APIs](https://developers.imiconnect.io/reference#overview-3). Please reach out to the support team to enable the JWT Authentication.
