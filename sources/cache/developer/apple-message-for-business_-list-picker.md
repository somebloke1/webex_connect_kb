...
Source: https://developers.webexconnect.io/reference/apple-message-for-business_-list-picker
...
```json
{
  ...
  "params": [
    {
      ...
      "in": "header",
      "ref": "",
      "_id": "642be0893f88ce03c094920c",
      "id": "642be0893f88ce03c094920c"
    },
    {
      ...
      "in": "body",
      "ref": "",
      "_id": "64316b786302b1002d5d20cf",
      "id": "64316b786302b1002d5d20cf"
    },
    {
      "name": "appid",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "64316b786302b1002d5d20ce",
      "id": "64316b786302b1002d5d20ce"
    },
    {
      "name": "destination",
      "type": "array_object",
      ...
      "in": "body",
      "ref": "destination",
      "_id": "64316b786302b1002d5d20cd",
      "id": "64316b786302b1002d5d20cd"
    },
    {
      "name": "channels",
      "type": "object",
      ...
      "in": "body",
      "ref": "channels",
      "_id": "64316b786302b1002d5d20cc",
      "id": "64316b786302b1002d5d20cc"
    },
    {
      "name": "correlationid",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "64316b786302b1002d5d20cb",
      "id": "64316b786302b1002d5d20cb"
    },
    {
      "name": "callbackData",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "64316b786302b1002d5d20ca",
      "id": "64316b786302b1002d5d20ca"
    },
    {
      "name": "notifyurl",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "64316b786302b1002d5d20c9",
      "id": "64316b786302b1002d5d20c9"
    },
    {
      "name": "authorization",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "6465f1ab33592e001708761d",
      "id": "6465f1ab33592e001708761d"
    },
    {
      ...
      "in": "body",
      "ref": "",
      "_id": "68c05e1724f93fb6c8d3aa2b",
      "id": "68c05e1724f93fb6c8d3aa2b"
    }
  ],
  "examples": {
    "codes": [
  ...
  "apiSetting": "6a675233ec1c893d8a7f67e3"
}
```
...
```json
{
  "openapi": "3.1.0",
  "info": {
    "title": "Apple Message for Business_List Picker",
    "version": "6.20.0"
  },
  "servers": [
    {
  ...
  "path_parameters": [],
  "operation": {
    "summary": "Apple Message for Business: List Picker",
    "description": "Allows the customer to choose from a list of items. A list picker displays a list of items, and information about the items—such as product name, description, and image—in the Messages app on the customer's device. The customer can choose one or more items from the list to send with a reply. _Note: Modify YourRegion in the URL to the right to reflect your tenant’s region. See [Know your endpoint page](https://developers.imiconnect.io/reference/endpoints)._",
    "operationId": "apple-message-for-business_-list-picker",
    "parameters": [
      {
        "name": "key",
        "in": "header",
                        ...
                        "properties": {
                          "data": {
                            ...
                            "properties": {
                              ...
                              "listPicker": {
                                "type": "object",
                                "description": "A dictionary that tells Messages how the list picker should behave and what content it should show to the customer.",
                                "properties": {
                                  "sections": {
                                    "type": "array",
                                    "description": "JSON object for sections configuration.",
                                    "items": {
                                      "properties": {
                                        "items": {
                                          "type": "object",
                                          ...
                                          "properties": {
                                            "style": {
                                              "type": "string",
                                              "description": "A string field of the item style. Styles available are: icon, small and large"
                                            },
                                            "title": {
                                              "type": "string",
                                            ...
                                            "subtitle": {
                                              "type": "string",
                                              "description": "A string field of the item's subtitle."
                                            },
                                            "order": {
                                              "type": "string",
                                              "description": "An integer representing the ordinal position for the item. If this key is missing, the item isn't sorted within the items array."
                                            },
                                            "identifier": {
                                              "type": "string",
                                              "description": "An identifier to identify the item."
                          ...
                          "receivedMessage": {
                            ...
                            "properties": {
                              "style": {
                                "type": "string",
                                "description": "A string field of the receivedMessage style. Styles available are: icon, small and large"
                              },
                              "title": {
                                "type": "string",
                                "description": "A string field of the received message subtitle."
                              },
                              "subtitle": {
                                "type": "string",
                                "description": "A string field of the receivedMessage subtitle."
                              },
                              "imageIdentifier": {
                                "type": "string",
