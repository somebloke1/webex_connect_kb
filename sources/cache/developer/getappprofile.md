...
Source: https://developers.webexconnect.io/reference/getappprofile
...
```json
{
  "url": "/customerappprofile/<appid>/<customerid>",
  "apiSetting": "6a675233ec1c893d8a7f67b8",
  "auth": "required",
  "examples": {
    "codes": [
      {
        "code": "-X GET https://api.imiconnect.io/resources/v2/customerappprofile/{inappid}/{customerId}\n-H \"Content-Type : application/json\"\n-H \"key : {profilekey}\"\n",
        "language": "curl",
        "name": null
      },
      {
      ...
      {
        "code": "https://api.imiconnect.com/resources/v1/customerappprofile/a_636035705699961900/8953",
        "language": "json",
  ...
  "params": [
    {
      ...
      "in": "path",
      "ref": "",
      "_id": "5f6df042f6c96a0023ed87c5",
      "id": "5f6df042f6c96a0023ed87c5"
    },
    {
      "name": "customerid",
      "type": "string",
      ...
      "in": "path",
      "ref": "",
      "_id": "5f6df042f6c96a0023ed87c4",
      "id": "5f6df042f6c96a0023ed87c4"
    },
    {
      "name": "Content-Type",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "5fd71ae5928e9f0012c3e0cf",
      "id": "5fd71ae5928e9f0012c3e0cf"
    },
    {
      "name": "secretKey",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "5fd71ae5928e9f0012c3e0ce",
      "id": "5fd71ae5928e9f0012c3e0ce"
    }
  ],
  "results": {
    "codes": [
...
```json
{
  ...
  "path": "/customerappprofile/<appid>/<customerid>",
  "method": "get",
  "path_parameters": [],
  "operation": {
    "summary": "Get App Profile by Customer ID",
    "description": "This API is used to retrieve a customer's application profile for a given *appid* and *customer profile key*. The *appid* is a unique ID for individual channel assets.",
              ...
              "oneOf": [
                {
                  ...
                  "properties": {
                    ...
                    "transid": {
                      "type": "string",
                      "example": "4bd0927e-df07-4b4c-a731-4912deaaa72c"
                    },
                    "Records": {
                      "type": "array",
                      "items": {
                ...
                },
                {
                  ...
                  "properties": {
                    ...
                    "transid": {
                      "type": "string",
                      "example": "c01bea92-6fc6-4416-b1da-79f15a19fd0c"
                    }
                  }
                },
                {
