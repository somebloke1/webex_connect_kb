...
Source: https://developers.webexconnect.io/reference/faqs-sms
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:31:52+00:00

## How Webex Connect can be used to receive inbound SMS messages

Webex Connect doesn't provide an inbox or an interface for viewing incoming SMS. 

However, you can forward the messages to your own applications by configuring an Outbound Webhook under integrations. 



![Screenshot of Configure Outbound Webhook Integration.](https://files.readme.io/e39dec5-Outbound_Webhook_to_Forward_Incoming_SMS.png)
...
Webex Connect offers 4 types of numbers; Landline, Mobile, Multi-function, and Toll-free. The capabilities of these numbers are available in the following table:



![Screenshot of Support for SMS on Toll-free numbers.](https://files.readme.io/97b3e49-Numbers.jpg)
...
**Long codes**, generally referred to as standard phone numbers, are 10 digit numbers used to send and receive SMS messages and phone calls. You can easily buy [new phone numbers](https://help.imiconnect.io/docs/buy-a-phone-number) using Webex Connect.
...
You can buy SMS short codes with Webex Connect by raising a request under 'Numbers > Get Numbers > Short Code' section. Refer to [Short Code](https://help.imiconnect.io/docs/shortcodes) section for more information.

## Releasing your unused Webex Connect numbers

You can easily cancel or release the numbers that you purchased using Webex Connect but do not use them any longer. If the number is currently in use or is mapped with any service, you will need to delink it before initiating the release. 
...
Login to Webex Connect and visit 'Numbers' section
...
![Screenshot of Manage Phone Number Page.](https://files.readme.io/244b8aa-Releasing_a_Number.JPG)
...
![Screenshot of Release Number Popup.](https://files.readme.io/2da3f09-image_14.png)
