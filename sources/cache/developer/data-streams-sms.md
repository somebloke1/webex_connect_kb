...
Source: https://developers.webexconnect.io/reference/data-streams-sms
...
| --- | --- | --- |
| transId | Unique transaction reference id of the request. | cfXXXX81-2XXe-  <br>4XX5-9XXd-36XXXXXXXX3a |
...
| messageCount | The number of segments in the incoming SMS message. | 1 |
...
| messageCount | The number of segments in the SMS message. This value will only be returned for Delivered and Failed delivery receipts.  <br>_Note: This field will not be available in Canada and India regions_ | 3 | Failed or Delivered |
...
| msg | Contains the message text sent by the user. | Your appointment is fixed for tomorrow. |
...
| msgtype | Contains the type of message sent. The possible values are:  <br>1 - text  <br>2- flash  <br>3- binary  <br>4-unicode | 1 |
| sr | Indicates whether a delivery report is expected from the mobile network provider. | 1 |
