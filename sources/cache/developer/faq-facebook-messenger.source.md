...
<<prodname>> by default gives you access to standard and subscription messaging via your Facebook pages linked in your <<prodname>> account. But, we expect that businesses adhere to the guidelines for sending promotional content as described above.
