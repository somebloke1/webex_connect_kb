...
Source: https://developers.webexconnect.io/reference/post_v1-groups-groupid-notifications-4
...
```json
{
  ...
  "path": "/v1/groups/{groupId}/notifications",
  "method": "post",
  "path_parameters": [
    {
  ...
  "operation": {
    ...
    "responses": {
      "204": {
        "description": "The subscription was successfully saved."
      },
      "404": {
