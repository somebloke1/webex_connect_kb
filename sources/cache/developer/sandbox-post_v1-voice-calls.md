...
Source: https://developers.webexconnect.io/reference/sandbox-post_v1-voice-calls
...
```json
{
  ...
  "operation": {
    ...
    "summary": "Place a new call to a telephone number",
    "parameters": [
      {
    ...
    "responses": {
      "202": {
        ...
        "content": {
          "application/json": {
            "schema": {
              "$ref": "#/components/schemas/NewCallStatus"
            }
          }
        }
      },
      ...
      "401": {
        "description": "unauthorized i.e. customer doestn't exist or customer account over quota",
        "headers": {
          "Request-Id": {
            "$ref": "#/components/headers/RequestId"
          }
      ...
      "callEvent": {
        "{$request.body#/callbackUrl}": {
          "post": {
                ...
                "application/json": {
                  "schema": {
                    "oneOf": [
                      ...
                      {
                        "$ref": "#/components/schemas/RecordedEvent"
                      },
                      {
                        "$ref": "#/components/schemas/CollectedDigitsEvent"
                      },
                      {
                        "$ref": "#/components/schemas/PlayedEvent"
                      },
                      {
                        "$ref": "#/components/schemas/DroppedEvent"
                      },
                      {
                        "$ref": "#/components/schemas/AnsweredEvent"
                      },
                      {
                        "$ref": "#/components/schemas/VoiceMailDetected"
                      }
                    ]
                  }
                }
            ...
            "responses": {
              "200": {
                "description": "Response should contain an action for the platform to perform on the call",
                "content": {
                  "application/json": {
                    "schema": {
                      "oneOf": [
                        {
                          "$ref": "#/components/schemas/AnswerAction"
                        },
                        {
                          "$ref": "#/components/schemas/PlayAction"
                        },
                        {
