...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "deliveryChannel",
    "0-1": "This is “email” in case of a email",
    "1-0": "Description",
    "1-1": "Provides supplementary details about the delivery event when relevant. For instance, in the case of Clicked Receipts, this field includes the URL that was clicked, followed by the IP address from which the click originated.",
    "2-0": "destinationType",
    "2-1": "This is \"email\" for Email channel.",
    "3-0": "timeStamp",
    "3-1": "Timestamp of the event",
    "4-0": "code",
    "4-1": "Status code as mentioned in the documentation",
    "5-0": "deliveryStatus",
    "5-1": "Status of the Email",
    "6-0": "destination",
    "6-1": "This contains the destination email id",
    "7-0": "additionalInfo",
    ...
    "8-0": "correlationid",
    "8-1": "The CorrelationID is a unique identifier that you can attach to every request as a reference a particular transaction or event. This is configured as a part of the request",
    "9-0": "callbackData",
    "9-1": "Data that you have configured to receive on the notify Url. This is configured as a part of the request",
    "10-0": "transid",
    "10-1": "Unique transaction reference id for this request",
    "11-0": "subtid",
    "11-1": "Sub-transaction reference id for this request"
  },
  "cols": 2,
  "rows": 12,
  "align": [
