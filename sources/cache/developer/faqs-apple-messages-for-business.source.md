...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/086ab49-image_26.png",
        "image (26).png",
        ""
      ],
      "align": "center",
...
Once your business account is approved, choose <<prodname>> as your CSP platform.
...
For any help with Apple Messages for Business approval, please reach out to the Support Team using the details mentioned in the ‘Contact Support’ section within your ”<<prodname>> account.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/551be0a-1cd7930-693ec95-Screenshot_2018-10-25_at_17.00.41.png",
        "1cd7930-693ec95-Screenshot_2018-10-25_at_17.00.41.png",
        "Screenshot of Messaging Service Platform Configuration on Apple Business Register."
      ],
      "align": "center",
      "caption": "Messaging Service Platform Configuration on Apple Business Register"
    }
  ]
}
[/block]
...
Now your Apple Messages for Business Account is ready to be used across <<prodname>> , IMIchat and IMIbot

## Migrating from an existing Service Provider

If you already have a live Apple Messages for Business account, it's easy to switch to <<prodname>> .
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/26f7519-image_27.png",
        "image (27).png",
        "Screenshot of Messaging Service Provider Configuration"
      ],
      "align": "center",
      "caption": "Messaging Service Provider Configuration."
    }
  ]
}
[/block]
...
All you have to do is go to Apple Messages for Business account settings and change your CSP configuration but you will need to ensure that you already the flows/chat setup on <<prodname>> to avoid down time for your customers.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ca1339b-image_28.png",
        "image (28).png",
        "Screenshot of Sample Text Message."
      ],
      "align": "center",
      "sizing": "30% ",
      "caption": "Screenshot of Sample Text Message."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ac1e0c9-image_29.png",
        "image (29).png",
        "Screenshot of Rich Links."
      ],
      "align": "center",
      "sizing": "30% ",
      "caption": "Screenshot of Rich Links."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b9ca2fb-image_30.png",
        "image (30).png",
        "Screenshot of List Pickers."
      ],
      "align": "center",
      "sizing": "30% ",
      "caption": "Screenshot of List Pickers."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/914a1f8-image_31.png",
        "image (31).png",
        "Screenshot of Time Pickers."
      ],
      "align": "center",
      "sizing": "30% ",
      "caption": "Screenshot of Time Pickers."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/00a9517-image_32.png",
        "image (32).png",
        "Screenshot of Apple Pay."
      ],
      "align": "center",
      "sizing": "30% ",
      "caption": "Screenshot of Apple Pay."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0b81078-FormMessages_FAQs1.jpeg",
        null,
        "Screenshot of Form Messages."
      ],
      "align": "center",
      "sizing": "200px",
      "border": true,
      "caption": "Screenshot of Form Messages."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bcbed8d-FormMessages_FAQs2.jpeg",
        null,
        "Screenshot of Form Messages."
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/55257f3-iMessageApps_FAQs1.jpeg",
        null,
        "Screenshot of iMessage App."
      ],
      "align": "center",
      "sizing": "200px",
      "border": true,
      "caption": "Screenshot of iMessage App."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8a5e02a-iMessageApps_FAQs2.jpeg",
        null,
        "Screenshot of iMessage App."
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/173e43b-image_33.png",
        "image (33).png",
        "Screenshot of Starting off with Apple Pay."
      ],
      "align": "center",
      "sizing": "30% ",
      "caption": "Starting off with Apple Pay."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1ca37e3-swimlanes-508e740462435c31bad4525f1313bdef.png",
        "swimlanes-508e740462435c31bad4525f1313bdef.png",
        "Screenshot of Apple Business Chat - Payments."
      ],
      "align": "center",
      "caption": "Screenshot of Apple Business Chat - Payments."
    }
  ]
}
[/block]
...
## Configure the App on <<prodname>> Platform
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0591b9f-dc6a7fd0-abf5-4392-be54-cee9c2dadc09.png",
        "dc6a7fd0-abf5-4392-be54-cee9c2dadc09.png",
        "Screenshot of OAuth authorization endpoint, OAuth token endpoint, OAuth client ID."
      ],
      "align": "center",
      "caption": "Screenshot of OAuth authorization endpoint, OAuth token endpoint, OAuth client ID."
    }
  ]
}
[/block]
...
- OAuth client secret - This needs to be entered on the ‘Manage App’ section of Apple Messages for Business app on <<prodname>> UI. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bef853b-fbfc541d-b7a1-48f1-9941-5153b74d84cd.png",
        "fbfc541d-b7a1-48f1-9941-5153b74d84cd.png",
        "Screenshot of Managing Apple Business Chat App Page."
      ],
      "align": "center",
      "caption": "Screenshot of Managing Apple Business Chat App Page."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5458cd4-BeFunky_Collage.jpg",
        "BeFunky Collage.jpg",
        "Screenshot of LinkedIn OAuth APIs."
      ],
      "align": "center",
      "caption": "Screenshot of LinkedIn OAuth APIs."
    }
  ]
}
[/block]
...
Any TPS restrictions imposed will be the restrictions that are applied to <<prodname>> tenant. If you face any issues with TPS, contact your account manager or send an email to the support team
