...
Source: https://developers.webexconnect.io/reference/mms-api
...
| --- | --- |
| channel | MMS |
| from | The number from which the MMS is sent  <br>  <br>The from number can only be one of the MMS enabled numbers provisioned for the account |
| to | The number to which MMS is sent  <br>  <br>The to number must follow E.164 format |
| notifyUrlAuthId | Unique Authentication ID. |
...
| Image | The URL must be publicly accessible and end with one of the following file types:  <br>.jpg = image/jpg, image/jpeg  <br>.png = image/png  <br>.gif = image/gif  <br>.avif = image/avif  <br>.heic = image/heic, image/heic-sequence | 750 KB |
| Audio | The URL must be publicly accessible and end with one of the following file types:  <br>.mp3 = audio/mp3, audio/mpeg  <br>.amr = audio/amr  <br>.m4a = audio/mp4 | 750 KB |
| Video | The URL must be publicly accessible and end with one of the following file types:  <br>.mp4 = video/mp4  <br>.3gp = video/3gpp | 750 KB |
...
| Synchronized Multimedia Integration Language (SMIL) | .smil = application/smil | 750 KB |
...
| --- | --- |
| 7000 | Invalid JSON |
| 7003 | Dynamic Format  <br>  <br>“Mandatory parameter missing: {{parameter}}” |
| 7004 | Dynamic Format  <br>  <br>“Invalid parameter: {{parameter}}” |
...
```json
{
  ...
  "params": [
    ...
    },
    {
      ...
      "enumValues": "",
      "default": "",
      "desc": "Service key available on the platform UI",
      "required": false,
      "in": "header",
      "ref": "",
      "_id": "60ed14971f0b29007be6198b",
      "id": "60ed14971f0b29007be6198b"
    },
    {
      "name": "Authorization",
      "type": "string",
  ...
  "examples": {
    "codes": [
      ...
      },
      {
        ...
        "language": "json",
        "name": "MMS with Multiple Attachments"
      },
      {
        ...
        "language": "json",
        "name": "MMS with Schedule Request"
      }
    ]
  },
  "apiSetting": "6a675233ec1c893d8a7f67c0"
}
```
  ...
  "operation": {
    ...
    "parameters": [
      ...
      },
      {
        "name": "key",
        "in": "header",
        "description": "Service key available on the platform UI",
        "schema": {
          "type": "string"
        }
      },
