# Delete Device Profile by Customer ID

Source: https://developers.webexconnect.io/reference/delete-device-profile-by-customer-id
...
```json
{
  ...
  "path": "/<appid>/deviceid/<deviceid>",
  "method": "delete",
  "path_parameters": [],
  "operation": {
    "summary": "Delete Device Profile by Customer ID",
    "description": "",
    "operationId": "delete-device-profile-by-customer-id",
    "responses": {
      "200": {
        "description": "200",
        "content": {
