<<prodname>> API endpoints for your account depend on the region your <<prodname>> account is hosted in. Here's a brief list to help you select the relevant API endpoints:
...
| <<prodname>> Sandbox | Sandbox.imiconnect.io     | Refer [sandbox specific API](https://developers.imiconnect.io/reference#sandbox-apis-overview) reference | Not available in Sandbox       | Not available in Sandbox        |
