<<prodname>> makes it easy for you to send  RCS messages programmatically by offering a rich set of Restful APIs. 
...
The following APIs are available for RCS using <<prodname>>:
...
- [RCS API ](https://developers.webexconnect.io/reference/rcs-api)- This API is used to send RCS messages using Send Message API v2 on the <<prodname>> platform.  
