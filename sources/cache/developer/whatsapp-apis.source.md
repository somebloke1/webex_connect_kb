...
[block:parameters]
{
  "data": {
    ...
    "0-0": "text",
    "0-1": "Yes",
    "0-2": "Contains the body field that you can use to pass the message content. The message can contain URLs and text formatting tags.",
    "1-0": "type",
    "1-1": "Yes",
    "1-2": "Specifies that message type. E.g., text.",
    "2-0": "preview_url",
    "2-1": "No",
    "2-2": "Options: false (default), true  \n  \nTo include a URL preview, set preview_url to true and make sure the URL begins with http\\:// or https\\://.  If multiple URLs are in the body text string, only the first URL will be rendered. Follow the [guidelines](https://developers.facebook.com/docs/whatsapp/link-previews) to make sure the URL preview is rendered by WhatsApp.",
    "3-0": "identity_key_hash",
    "3-1": "No",
    "3-2": "Pass this value to validate the identity of your customer. More details on Identity Key Hash feature are documented in [WhatsApp Node](https://help.webexconnect.io/docs/whatsapp-node#identity-hash-field) documentation.",
    "4-0": "options",
    "4-1": "No",
    "4-2": "A JSON object that contains additional, SMS-specific options such as trackClicks, shortenLinks, and domain in the API.",
    "5-0": "trackClicks",
    "5-1": "No",
    "5-2": "You can receive ‘CLICKED’ notifications for shorten links on your notifyUrl by enabling trackClicks. You can also receive them on your SMS webhook if the ‘Clicked’ option is selected.  \nThe ‘trackClicks’ option is set to ‘false’ by default.  \nClicked format details are available [WhatsApp Delivery Receipts](https://developers.webexconnect.io/reference/whatsapp-outbound-webhooks#whatsapp-delivery-receipts) documentation.",
    "6-0": "shortenLinks",
    "6-1": "No",
    "6-2": "When enabled, this shortens any HTTPS links in the message request's body. For more information, refer to[ configure shortenLinks ](https://developers.webexconnect.io/reference/send-sms-message-api-v2#steps-for-configuring-branded--short-urls-for-smartlinks--shortenlinks-capability)section.The expiry of the shortened URL is 180 days.",
    "7-0": "domain",
    "7-1": "Yes",
    "7-2": "It is the domain configuration for shortening the links.  \n_Note: 'domain' is mandatory only when 'options' object is used in the payload._",
    "8-0": "tags",
    "8-1": "Yes",
    "8-2": "The reporting tags are for tracking the shortened link's creates and clicks.",
    "9-0": "allowFallbackURL",
    "9-1": "Yes",
    "9-2": "If true, the long URL passed will be sent in case the SLS service is down or fails to create the shortened link.",
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "Description",
    "0-0": "type",
    "0-1": "Yes, when type is image, audio, document or sticker",
    "0-2": "image, audio, document, video or sticker. Refer below table to know more about each of these types.",
    "1-0": "caption",
    "1-1": "No",
    "1-2": "Describes the specified image, video, or document media. Do not use with audio or sticker media.",
    "2-0": "url",
    "2-1": "yes",
    "2-2": "Direct URL pointing to the media file. The URL should end with specified file-format.  \n  \nYou can use our Media manager under Tools to upload a file and get a public URL.",
    "3-0": "mimeType",
    "3-1": "yes",
    "3-2": "Supported mime types. Find more details [here](https://help.imiconnect.io/docs/supported-file-types-for-channels#whatsapp)",
    "4-0": "identity_key_hash",
    "4-1": "No",
    "4-2": "Pass this value to validate the identity of your customer. More details on Identity Key Hash feature are documented [here.](https://help.webexconnect.io/docs/whatsapp-node#identity-hash-field) "
  },
  "cols": 3,
  "rows": 5,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "h-3": "Maximum Size",
    "0-0": "audio",
    "0-1": "Yes, when \"type\": \"audio\".",
    "0-2": "The media object containing audio.  \nSupported audio formats are AAC, MP4, MPEG, AMR,  \nOGG; codecs=opus  \nNote: The base ogg type is not supported.  \nOPUS is deprecated.",
    "0-3": "16 MB",
    "1-0": "document",
    "1-1": "Yes, when \"type\": \"document\".",
    "1-2": "The media object containing a document.  \nSupported document formats are TXT, PDF, XLS, DOC, PPT, XLS(X), DOC(X) and PPT(X), The media object containing a XLS(X) file",
    "1-3": "100 MB",
    "2-0": "image",
    "2-1": "Yes, when \"type\": \"image\".",
    "2-2": "The media object containing an image.  \nSupported image formats are JPEG and PNG",
    "2-3": "5 MB",
    "3-0": "video",
    "3-1": "Yes, when \"type\": \"video\"",
    "3-2": "The media object containing a video. Supported formats are 3GPP and MP4  \nNotes:  \nOnly H.264 video codec and AAC audio codec is supported.  \nWhatsApp support videos with a single audio stream or no audio stream.",
    "3-3": "16 MB",
    "4-0": "sticker",
    "4-1": "Yes, when \"type\":\"sticker\"",
    "4-2": "The media object containing a sticker. Supported format WEBP",
    "4-3": "Static stickers: 100KB  \n  \nAnimated stickers: 500KB"
  },
  "cols": 4,
  "rows": 5,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Parameters within an object",
    "h-2": "Mandatory",
    "h-3": "Description",
    "0-0": "namespace",
    "0-1": "Yes",
    "0-2": "Yes",
    "0-3": "The namespace that will be used.",
    "1-0": "element_name",
    "1-1": "Yes",
    "1-2": "Yes",
    "1-3": "The element name that indicates which template to use within the namespace.",
    "2-0": "language",
    "2-1": "",
    "2-2": "",
    "2-3": "The language parameter sets the language policy for a Message Template.",
    "3-0": "",
    "3-1": "policy",
    "3-2": "Yes",
    ...
    "4-1": "code",
    "4-2": "Yes",
    "4-3": "The code of the language or locale to use — Accepts both language and language_locale formats (e.g., en and en_US).",
    "5-0": "localizable_params",
    "5-1": "Yes",
    "5-2": "Yes",
    "5-3": "This field is an array of values to apply to variables in the template  \nSee the Localizable Parameters section for more information."
  },
  "cols": 4,
  "rows": 6,
  "align": [
...
[block:parameters]
{
  "data": {
    "h-0": "Parameter name",
    "h-1": "Description",
    "h-2": "Object Configuration",
    "0-0": "movie/venue/seat1/seat2",
    "0-1": "Simple text variable. Configured parameter key for e.g., <movie> should be the name of the variable specified during template creation. ",
    "0-2": "NA",
    "1-0": "time",
    "1-1": "Localisable time variable. Configured parameter key <time> should be the name of the variable specified during template creation",
    "1-2": "_ **Fallback_value**: The fallback value that appears to the customer when the localization fails. This is a mandatory parameter.  \n_ **Timestamp**: UNIX epoch timestamp that is used to calculate the localized date and time. Go to [epoch convertor](https://www.epochconverter.com/) for timestamp conversion.",
    "2-0": "purchase_value",
    "2-1": "Localisable currency variable. Configured parameter key \\<purchase_value> should be the name of the variable specified during template creation.",
    "2-2": "_ **type**:\tParameter indicates the type as \"currency\".  \n_ **currencycode**_:\tThe currency code for e.g., USD, EUR, INR, etc.  \n_ **amount1000**_: \tThe actual amount multiplied by 1000.  \n_ **fallback_value**:\tThe fallback value that appears to the customer when the localization fails.  \n_Note: All parameters are mandatory_"
  },
  "cols": 3,
  "rows": 3,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "Object Configuration",
    "0-0": "ctaVariable",
    "0-1": "CTA button dynamic URL configuration. Configured parameter key <ctaVariable> should be the name of the variable specified during template creation.",
    "0-2": " **type**: Extension of the URL in case of CTA buttons. It cannot be the domain of the URL.  \n **payload**: Specify Dynamic Extension of the URL  \n_Note: All parameters are mandatory_",
    "1-0": "quickReply",
    "1-1": "Configure upto three quick reply buttons. Specify parameter key as 'quickReply'.",
    "1-2": "_ **button_text**: Configure the value of the <buttontext> as the name of the button specified during template creation here.  \n_ **payload**: Configure unique button payload. This will be returned back as part of Postback event in Webex Connect incoming components.  \n_Note: All parameters are mandatory_",
    "2-0": "otp",
    "2-1": "Configure value of the OTP. This is applicable only in case of Authentication template. Specify parameter key as 'otp'.",
    "2-2": "_ **type**: specify type as ‘otp' under the otp object to pass the code value within the 'value field’.  \n_ **value**: Configure the OTP value without spaces with maximum character supported upto 15 characters.  \n_Note: All parameters are mandatory_"
  },
  "cols": 3,
  "rows": 3,
  "align": [
