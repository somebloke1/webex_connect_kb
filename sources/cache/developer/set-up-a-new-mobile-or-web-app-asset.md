...
Source: https://developers.webexconnect.io/docs/set-up-a-new-mobile-or-web-app-asset
...
![Screenshot displaying the Assets Menu.](https://files.readme.io/17fd152a08d25c0c9cb5cc7f34ed22ce609ba258354091d54964a5062863d0aa-Apps.png)
...
![Screenshot of selecting the Mobile / Web App.](https://files.readme.io/5ed464cbc7c5454f01544d877849f5cc70f21afdd2361b918eff446612114786-Configure.jpg)
...
![Screenshot of Configuring New Mobile & Web App Page](https://files.readme.io/9938c430e563f7ee8b2f17589c899feffac16a43ae8b512033d3b320a5dc309a-New_assets_step5.png)
...
![Screenshot of SDK Configuration Files](https://files.readme.io/79620aee5f83e23c12fa1097119ed5139184a035e9b3376d9eff9d3a787471be-SDK_Configuration_Files.png)
...
![Screenshot of Push and Live Chat / In App Messaging Notifications Section.](https://files.readme.io/a5cc1757544cc4c7dbd037c0146b1f1287a27d4cdf53e4aea4423d5aab0c49cc-SDK_Configuration_Files_-_Both_options.png)
...
![Screenshot of Live Chat / In-App Messaging Section.](https://files.readme.io/c0dfed5e6f38ab397c36d2af94f4a6db4deaec272a133f5c18ed121e7d2d4464-Screenshot_2025-04-16_at_2.00.48_PM.png)
...
| No. | Advanced Settings | Mandatory/Optional | Description |
| --- | --- | --- | --- |
| 1. | JWT Authorization -  <br>a. Symmetric  <br>b. Asymmetric | Optional | a. Symmetric: Configure JWT authorization to provide JWT secret key.  <br>b. Asymmetric: Upload the JWK keys. |
| 2. | Allow Multi User Registrations on Same Device | Optional | Multi-User Registration allows you to have multiple users registered from a single device at the same time. This will ensure that push notification sent to any of the registered user will be delivered on the device. However if the notification is sent to all the users registered on a device parallelly, you would see duplicate push notifications on that given device. |
| 3. | Single Device Per User | Optional | Restricts access to the application to one user per device. If you register on a new device, you will stop receiving push notifications on the older device. |
| 4. | Server Side Inbox | Optional | Allows the storage of data on server of Webex Connect. |
| 5. | Data Stream | Optional |  |
...
![Source screenshot](https://files.readme.io/67bcc7587705d059073bab85c4aeb7aa0b0061ad41e466efdba58e141d3e4031-Screenshot_2025-04-16_at_2.15.52_PM.png)
...
![Screenshot of JWT Authorization Section.](https://files.readme.io/77bafdc4a187acb2d3a850a492e67d652a17ff82781cf662734fe81b8ac73384-Existing_assets_Standalone.png)
...
![Screenshot of Asymmetric JWT Authorization](https://files.readme.io/4c18583a1beea37e35faa65734cde0904c9040c1622a0f60e35ca99baa15128a-New_assets_Standalone.png)
...
![Screenshot of Apps Page.](https://files.readme.io/710b0f0-Mobile11.jpeg)




To configure a project, visit [Project Setup](https://developers.webexconnect.io/docs/quickstart-guide-2#section-project-setup)