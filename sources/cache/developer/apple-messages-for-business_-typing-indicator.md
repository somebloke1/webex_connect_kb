# Apple Messages for Business: Typing Indicator

Source: https://developers.webexconnect.io/reference/apple-messages-for-business_-typing-indicator
  ...
  "params": [
    {
      ...
      "in": "body",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fbc",
      "id": "642bf6311d3d270b57b27fbc"
    },
    {
      "name": "appid",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fbb",
      "id": "642bf6311d3d270b57b27fbb"
    },
    {
      "name": "destination",
      "type": "array_object",
      ...
      "_id": "642bf6311d3d270b57b27fba",
      "id": "642bf6311d3d270b57b27fba"
    },
    {
      "name": "channels",
      "type": "object",
    ...
    },
    {
      ...
      "in": "body",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fb8",
      "id": "642bf6311d3d270b57b27fb8"
    },
    {
      "name": "conversationid",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fb7",
      "id": "642bf6311d3d270b57b27fb7"
    },
    {
      "name": "callbackData",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fb6",
      "id": "642bf6311d3d270b57b27fb6"
    },
    {
      "name": "notifyurl",
      "type": "string",
      ...
      "in": "body",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fb5",
      "id": "642bf6311d3d270b57b27fb5"
    },
    {
      "name": "key",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "642bf6311d3d270b57b27fb3",
      "id": "642bf6311d3d270b57b27fb3"
    },
    {
      "name": "authorization",
      "type": "string",
      ...
      "in": "header",
      "ref": "",
      "_id": "6465f23165e5fd0018e278e2",
      "id": "6465f23165e5fd0018e278e2"
    },
    {
      ...
      "in": "body",
      "ref": "",
      "_id": "68c050d602e1e173d11fe023",
      "id": "68c050d602e1e173d11fe023"
    }
  ],
  "examples": {
    "codes": [
      ...
      },
      {
        "code": "{\n\t\"deliverychannel\": \"AppleBusinessChat\",\n\t\"appid\": \"{{ambAppid}}\",\n\t\"destination\": [{\n\t\t\"abcUserId\": [\"{{abcUserId}}\"]\n\t}],\n     \"channels\": {\n        \"AppleBusinessChat\": {\n            \"type\": \"typing_end\"\n        }\n    },\n    \"correlationid\": \"\",\n    \"conversationid\": \"\",\n    \"callbackData\": \"\",\n    \"notifyurl\": \"\"\n    \"notifyurlAuthId\": \"TNPBXKT09U\" //Optional.\n   \n   \n}\n ",
        "language": "json",
        "name": "Typing Indicator End"
      }
    ]
  },
  "apiSetting": "6a675233ec1c893d8a7f67e0"
}
```
...
```json
{
  "openapi": "3.1.0",
  "info": {
    "title": "Apple Message for Business_Typing Indicator",
    "version": "6.20.0"
  },
  "servers": [
    {
  ...
  "path_parameters": [],
  "operation": {
    "summary": "Apple Messages for Business: Typing Indicator",
    "description": "Used to let the customer whether the business agent started or ended typing. _Note: Modify YourRegion in the URL to the right to reflect your tenant’s region. See [Know your endpoint page](https://developers.imiconnect.io/reference/endpoints)._",
    "operationId": "apple-messages-for-business_-typing-indicator",
    "parameters": [
      {
        "name": "key",
        "in": "header",
              ...
              "destination": {
                ...
                "items": {
                  "properties": {
                    "abcUserId": {
                      "type": "array",
                      "description": "User's Opaque ID _Note: For more information please [refer](https://register.apple.com/resources/messages/messaging-documentation/faq)_",
                      "default": [],
                      "items": {
                        "type": "string"
                      }
                ...
                "properties": {
                  "AppleBusinessChat": {
                    ...
                    "properties": {
                      "type": {
                        "type": "string",
                        "description": "Type of the outbound event. It can be text ; typing_start, typing_end.",
                        "default": "typing_start"
                      }
                    }
                  }
                }
