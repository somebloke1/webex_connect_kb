...
Source: https://developers.webexconnect.io/reference/topic-apis-overview
...
> 📘 JWT Authentication
> 
> Webex Connect allows using JWT Authentication for the [Thread APIs](https://developers.imiconnect.io/reference#overview-of-thread-apis), [Segment APIs](https://developers.imiconnect.io/reference#overview-4), and Topic APIs. Please reach out to the support team to enable the JWT Authentication.
