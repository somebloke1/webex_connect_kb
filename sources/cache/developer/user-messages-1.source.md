...
> 📘 Know Your Endpoint
> 
> Based on the domain you use to log in to <<prodname>> , the endpoint for your API varies. See the [endpoint](https://developers.imiconnect.io/reference/endpoints) section to understand which endpoint to use for your domain.