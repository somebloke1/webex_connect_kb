...
Source: https://help.webexconnect.io/docs/smart-links
...
![Screenshot of Smart links page](https://files.readme.io/6b6700b-image.png)
...
| Total Links Sent | Displays the count of link sent by various channels.  <br>  <br>**Note**: The data will be displayed only for the last 30 days. |
| Total Clicks | Displays the total number of links clicked.  <br>  <br>**Note**: The data will be displayed only for the last 30 days. The bot/preview clicks are ignored when identified. |
| Status | Displays the status. |
| Device Based Routing | Enabled or Disabled is displayed based on the configuration. |
| Actions | Manage - You can update the smart links information.  <br>  <br>Delete - You can delete the smart links. |
...
![Screenshot of Configuring the New Smart Link](https://files.readme.io/8235f47-image.png)
...
| Long URL | The long URL that is to be shortened. Along with Http and Https URLs, below URLs are also supported for redirecting users from Smart links to SMS app on Android phones.  <br>  <br>Eg: \<sms:[webex-connect-cloud@abc.goog](mailto:webex-connect-cloud@abc.goog)  ?body=survey&bot-name=Webex%20Connect%20Cloud>  <br>  <br>and  \<sms:+4454XXXXX7435?service_id=[webex-connect-cloud@abc.goog](mailto:webex-connect-cloud@abc.goog)  &body=Hello%20Tom&bot-name=Webex%20Connect%20Cloud> |
| Short Domain | The Default available short domain list  will be based on the Environment  <br>  <br>Eg: <https://s-us.imiconnect.io> and <https://s.imiconnect.eu>.  <br>  <br>Custom domains must be registered with Webex Connect. To register your domain with Webex Connect, contact the Webex Connect support team. |
