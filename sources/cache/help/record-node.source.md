...
The _Record_ node can exist only within the [Voice Node Group](doc:voice-node-group).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b3706b4-record.png",
        "record.png",
        "Screenshot of Record Node."
      ],
      "align": "center",
      "caption": "Record Node"
    }
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f4d207a-Record.jpg",
        "Record Node.png",
        "Screenshot of Configuring a Record node."
      ],
      "align": "center",
      "border": true,
      "caption": "Configuring a Record node"
    }
  ]
}
[/block]
...
You can see the data that this node generates as output variables. These [variables](doc:variable-management) are available for use in subsequent nodes. The following are the standard output variables for the _Record_ node:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/161b4e7-Record1.jpg",
        "Record Node Output Variables.png",
        "Screenshot of Record Node Output Variables"
      ],
      "align": "center",
      "sizing": "300px",
      "border": true,
