...
Source: https://help.webexconnect.io/docs/apple-messages-for-business-node
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:28:52+00:00

The Apple Messages for Business node enables you to send imessages to the iPhone, iPad, Mac, and Apple Watch users. Apart from sending text messages and attachments, you can also send rich links, list pickers, and time picker.
...
When you double-click this node, the Apple Messages for Business screen appears with three tabs: Configuration, Transition Actions, and Data Stream. The Configuration tab enables you to configure the message settings whereas the Transitions Actions tab provides configuring the node on-enter/on-leave operations.



![Apple Messages for Business Node](https://files.readme.io/47fd871-6.png)




Message Types supported by Webex Connect:
...
![Screenshot of Node Configuration Page.](https://files.readme.io/673420e-3.jpeg)
...
| Element | Description |
| --- | --- |
| Configuration tab | Use this tab to configure the message settings.  <br>  <br>Here is the description for the fields:  <br>  <br>**DESTINATION TYPE** Select `User ID` for standard Apple Messages for Business message types. Select `msisdn` when the message type is `Invitation Message`.  <br>  <br>**DESTINATION** Specify the Apple Messages for Business user ID for standard message types. For `Invitation Message`, specify the customer's mobile number in E.164 format, or enter a variable that contains the mobile number.  <br>  <br>**WAIT FOR** This dropdown box contains the below option:  <br>**GW submit**: Use this option to configure the flow to wait until the message is submitted to the gateway. Along with configuring this option, specify the timeout in seconds in the corresponding **Timeout ** field.  <br>  <br>**EXPIRY** This dropdown box contains the below two options:  <br>  _ **UTC**:  Use this option to specify the date when the message should expire.  <br>  _ **Seconds**: Use this option to specify the message expiry time in seconds.  <br>  <br>**MESSAGE TYPE** Select the message type that you want to send. `Invitation Message` is available when **Destination Type** is `msisdn`. All other Apple Messages for Business message types are available when **Destination Type** is `User ID`. This dropdown box contains the below message types:  <br>  <br>**Invitation Message:** Use this option to send an Apple Messages for Business invitation message to an opted-in customer mobile number. For more information, refer to **Configuring an Invitation Message** below.  <br>  <br> **Text:** Use this option to send a static text message.  <br>For more information, refer to **Sending a Text Message** below.  <br>  <br>**Text with Attachments:** Use this option to send a static text message along with attachments.  <br>For more information, refer to **Sending an Attachment** below.  <br>  <br> **Rich Link:** Use this option to send a rich link, which enables the user to preview the content inline without first loading a preview.  <br>For more information, refer to **Sending a Rich Link** below.  <br>  <br>**List Picker**: Use this option to send a list picker, which displays a list of items along with item information on the customer's device.  <br>For more information, refer to **Sending a List Picker** below.  <br>  <br>**Form Message**  <br>  <br>**Payment**  <br>  <br>**Classical Authentication (Deprecated)**  <br>  <br>**iMessage App**  <br>  <br>**New Authentication Message**  <br>  <br>**Authentication**:  <br>  <br>**ADD SMART LINK** Click this link if you wish to add a smart link.  <br>  <br>**Note:** SmartLink is a single URL, which contains multiple various offers in it. For example, you can create a single URL for multiple network marketing channels including email, SMS, company website, and social. |
| Transition Actions tab | Use this tab to configure node on-enter/on-leave operations.  <br>  <br>Here is the description for the fields:  <br>  <br>**Add action link**  <br>Click it to view the Transition action fields. |
| Input Variables | Click this collapsible panel to view the list of all the available flow variables. You can search for a variable using the Search field. You can also add a variable to the flow variables list by clicking the Add new flow variable link at the bottom of the list. |
| Output Variables | Click this collapsible panel to view the output variables. The data generated by the node is displayed as variables here. |
| Node Outcomes | Click this collapsible panel to view the list of possible node outcomes. You can also customize the node labels by clicking the Edit icon. |
...
You can configure the Apple Messages for Business node to send text messages, attachments, rich links, time pickers, and list pickers. 
...
> 📘 Note
> 
> For Apple Messages for Business **Invitation Message**, the **Destination Type** is `msisdn` and the **Destination** field contains the customer's mobile number. 
> 
> For all other Apple Messages for Businessmessage types, the **Destination Type** remains `User ID` and the **Destination** field contains the Apple Messages for Business user ID.

1. Double-click the **Apple Messages for Business** node.  
   The Apple Messages for Business screen appears. 

   

![Screenshot of Configuration General Settings.](https://files.readme.io/781730e-3.jpeg)


2. On the Configuration tab: 
   1. Select **User ID** from the **Destination Type** dropdown.
   2. Enter the Apple Messages for Business ID in the **Destination **field. 
...
![Screenshot of Add Preview For Domain Button.](https://files.readme.io/10c0cac-AMB_Rich_Links.jpg)
...
![Screenshot displaying to enter domain name.](https://files.readme.io/1a79aa2-AMB_Rich_Links1.jpg)
...
![Screenshot displaying to upload the image file.](https://files.readme.io/f5a28e6-AMB_Rich_Links3.png)
...
> 🚧 
> 
> Note that Webex Connectallows for a maximum of 10 time slot options to be sent as part of single Time Picker message.
...
![Screenshot of Node Configuration Page.](https://files.readme.io/3774f49-4.jpeg)
...
![Payment Configuration](https://files.readme.io/64d9fe0-apple-pay-config.png)
...
![Classical Authentication Configuration](https://files.readme.io/1cb3b1b-5.png)
...
1. On the **Apple Messages for Business** screen, click the **Transition Actions** tab.
...
![Screenshot of Form Elements.](https://files.readme.io/c0d6985-7.png)
...
![Screenshot of Configuring an iMessage App.](https://files.readme.io/4fb2468-8.png)
...
![Screenshot of Configuring a New Authentication.](https://files.readme.io/0e55d53-9.png)
...
![Screenshot of Configuring a Quick Reply](https://files.readme.io/a890df4-10.png)
...
| Node Edge | Outcome Description |
| --- | --- |
| Green | onSuccess- this is success event |
| Red | onError  <br>onPolicyFail-this is onpolicyfail event |
