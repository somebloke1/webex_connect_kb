Email as a channel enables users to send plain text or rich HTML email messages with tables, embedded links, and attachments via the <<prodname>> platform. 

> 📘 Note
> 
> The following Email App Configuration instructions are not applicable for Webex CC and <<prodname>> integration. If you looking for Email app configuration instructions for Webex CC integration please refer to [Email section](https://help.imiconnect.io/docs/wxcc-email-asset-creation).
...
To set up an Email app in <<prodname>>, you need to have a domain to send or receive emails. The same email domain should be registered with <<prodname>> under the Apps section. 

> 📘 Note
> 
> <<prodname>> offers the ability to send Emails via two routes - Amazon Simple Email Service (Amazon SES) or Simple Mail Transfer Protocol (SMTP). One of these two routes will be available in your tenant depending on the tenant configuration at the time of onboarding. This is configured in the Admin console while setting up your tenant.
> 
> If you have chosen to use AWS SES route, you can reach out to the <<prodname>> support team (refer to the details available within Contact Us page in your <<prodname>> account) to get AWS SES credentials that are needed for completing Email channel set-up. Please make sure to convey the region you would like your AWS SES account to be set-up in from the AWS Region dropdown available in the email app asset configuration page.
> 
> We recommend using the AWS SES credentials provided by <<prodname>> team. However, if you want to use your own AWS SES account, you're required to follow the below mentioned configurations within AWS before you get started with email channel configuration within <<prodname>>. Please note that the Webex Connect standard email pricing applies even when you choose to bring your own AWS SES account.
...
> 📘 Note
> 
> This is an optional step that's needed only to clients who want to use their own AWS SES account instead of the one provided by <<prodname>> team.

> 📘 Note
> 
> Please do not enable Amazon SES account-level suppression list on the SES Console to make sure unintended bounces do not occur. Please note that <<prodname>> already handles bounces.

As the first step, you need to make relevant AWS configurations to provide programmatic access to <<prodname>> for your AWS SES and SNS service. 
...
Steps for providing programmatic access to <<prodname>> (admin level access):
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/062a6cc-ses-iam-1.png",
        "ses-iam-1.png",
        "Screenshot of Set User Details"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Set User Details."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/376d243-Permissions_for_Email_Asset_Creation.PNG",
        "Permissions for Email Asset Creation.PNG",
        "Screenshot of Add Permissions."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Add Permissions"
    }
  ]
}
[/block]
...
7. As you see in the below screenshot, you get an **Access key ID** and a **Secret access key** at this stage. These are required to be entered during email app creation in <<prodname>>.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7647563-CCE5.png",
        "ses-iam-3.png",
        "Screenshot Displaying the Success Message."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot Displaying the Success Message."
    }
  ]
}
[/block]
...
1. Login to your <<prodname>> account and navigate to **Assets** > **Apps** section.
...
4. Enter the 'Access Key ID' and 'Access Key Secret' that were provided by <<prodname>> support team, or generated by you in case you are using your own AWS SES account and follow the optional first step.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1ef0c4b-Screenshot_2023-07-18_at_11.26.50_PM.jpeg",
        null,
        "Screenshot Displaying the Access Credentials."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot Displaying the Access Credentials."
    }
  ]
}
[/block]
...
5. Enter the 'Access Key ID' and 'Access Key Secret' that were provided by <<prodname>> support team, or generated by you in case you are using your own AWS SES account and follow the optional first step.
   > 📘 Note
   > 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f98faa4-Email1.png",
        "Email-Txt-Records-imiconnect.png",
        "Screenshot Displaying the TXT Records."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot Displaying the TXT Records."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/36b8c12-email_app_dkim_settings.png",
        "email_app_dkim_settings.png",
        "Screenshot of DKIM Settings"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of DKIM Settings."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/01cf986f255eb467676bd6cb051d48812b026f9852a34a128e79ab6fb4ff2ea6-SPF.png",
        "",
        "Screenshot of Sender Policy Framework Authentication"
      ],
      "align": "center",
      "border": true,
      "caption": "Sender Policy Framework Authentication"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6014b54c494e66746f9c3530992daacd9bf70868cc86bcfb5f8e07e060a6ed88-DMAARC.png",
        "",
        "Screenshot of DMARC Policy Setting."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of DMARC Policy Setting."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/637bf545fd3849d253673b0581e22caaeb1f6a9cd7c6ab81095ad9d6d6b1404d-IPS.png",
        "",
        "Screenshot of Dedicated IPs."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Dedicated IPs."
    }
  ]
}
[/block]
...
> 📘 Note
> 
> Please note that AWS SES supports inbound email option only in a few regions and it may not be able in the region your <<prodname>> account is hosted. Refer [AWS SES documentation](https://docs.aws.amazon.com/ses/latest/dg/regions.html#region-endpoints) to know more about this limitation.
...
The steps until this stage were all related to configurations required for sending outbound emails using AWS SES. If you want to use <<prodname>> for receiving emails, you need to add the MX records shown in the UI to your domain's DNS settings to allow <<prodname>> to receive emails on the registered domain.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/77c7dd5-email_app_inbound_email.png",
        "email_app_inbound_email.png",
        "Screenshot of Inbound Email."
      ],
      "align": "center",
      "caption": "Screenshot of Inbound Email."
    }
  ]
}
[/block]
...
<<prodname>> platform offers the ability to add an unsubscribe URL to the emails sent via Webex Connect. You will need to enable the 'Unsubscribe' option during email app asset configuration as shown below. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c64c7c7-Email_Unsubscribe.png",
        "Email_Assets_Unsubscribe.png",
        "Screenshot of Managing Email Unsubscribes."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Managing Email Unsubscribes."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/eea5d98-image.png",
        null,
        "Screenshot of Configuring New Outbound Webhook Integration Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configuring New Outbound Webhook Integration Page."
    }
  ]
}
[/block]
...
Once the above settings are enabled, you will need to add an unsubscribe link to the footer of your email templates using the <<prodname>> email composer accessible in the Templates section. 
...
> 
> Also, the validation whether a recipient has unsubscribed from receiving any further emails is supported only for 'To' email addresses in your request. At the moment, <<prodname>> does not check subscription status for email addresses mentioned in 'CC' and 'BBC' fields.

<<prodname>> maintains a list of unsubscribed email ids at the email app asset level. While sending emails, <<prodname>> identifies and filters the unsubscribed emails from the send list i.e., <<prodname>> validates the targeted users against the unsubscribed list before delivery of emails.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a847742-image.png",
        null,
        "Screenshot of Sending Limits."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Sending Limits."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cd54fc4-1.jpg",
        null,
        "Screenshot of Configuring New Email Application."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configuring New Email Application."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9a806fa-2.jpg",
        null,
        "Screenshot of Selecting the Authentication Protocol."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Selecting the Authentication Protocol."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f1ed75d-email-image2.png",
        null,
        "Screenshot of Toaster Message for Connection Established successfully."
      ],
      "align": "center",
      "sizing": "350px",
      "border": true,
      "caption": "Screenshot of Toaster Message for Connection Established successfully."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6bc60b682a80f8b9a2a104de9f09ee5950d8af37fec652f4df914b384a1df9d1-eu.webexconnect.io_apps_email-smtp_4.png",
        null,
        "Screenshot of Configuring New Email App Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configuring New Email App Page."
    }
  ]
}
[/block]
