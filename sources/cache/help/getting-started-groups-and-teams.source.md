<<prodname>> offers the ability to add users at one of the following levels to help you organize your platform usage as per your organizational structure: 
...
The following diagram illustrates the hierarchy of users within <<prodname>>.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2557749-Account_Hierarchy_-_Client_Groups_Teams.png",
        "Account Hierarchy - Client, Groups, Teams.png",
        "Hierarchy of users within Webex Connect"
      ],
      "align": "center",
      "caption": "Hierarchy of users within Webex Connect"
    }
  ]
}
[/block]
