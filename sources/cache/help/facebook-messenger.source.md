...
Users can easily connect their Facebook pages with <<prodname>> and build rich messaging experiences using messaging API and/or flow builder. We support various rich messaging features offered by Facebook Messenger such as carousels, quick replies, emojis, persistent menus, and templates.

> 📘 Messenger Graph API version upgrade
> 
> The Messenger version for <<prodname>> v5.5.3 or below is v3.2 to v6.0. The Messenger version for <<prodname>> v5.6.0 is v8.0 to v16.0.
...
You can register your Facebook Messenger page with <<prodname>> from 'Assets > Apps' section. Following are the steps for registering:

1. Select **Messenger ** from **Configure New App** dropdown. 
2. Provide a name for your Messenger app asset and click **Add Messenger Page**. You must be the admin of the Facebook page to integrate Facebook Messenger with <<prodname>>. At this stage, you'll be redirected to your Facebook login page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dfbec0e-Assets_Messenger_Configuring_your_Messenger_App_on_imiconnect.png",
        "Assets Messenger Configuring your Messenger App on imiconnect.png",
        "Screenshot of Configure New Messenger App Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configure New Messenger App Page."
    }
  ]
}
[/block]
...
5. Provide the requested access permissions, and click **Done**.  
   At this stage, you'll be redirected to <<prodname>>. If you selected multiple pages in the previous step, you'll be asked to choose the page that you want to use for the asset you are configuring. Select the required page.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2fc5ecc-1.jpg",
        "messenger_app_asset_configuration.png",
        "Screenshot of Manage Messenger App Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Adding a Facebook page to <<prodname>> - Assets -> Apps -> Configure New App"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c447f16-23423215_1791233210947700_2174958476483100672_n.png",
        "23423215_1791233210947700_2174958476483100672_n.png",
        "Screenshot of Message Us."
      ],
      "align": "center",
      "sizing": "150px",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f1a185b-16685647_261975084241469_2329165888516784128_n.png",
        "16685647_261975084241469_2329165888516784128_n.png",
        "Screenshot of Messenger Code."
      ],
      "align": "center",
      "border": true,
      "caption": "Messenger Code"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9e2de0e-6a7978c-21274929_1469790786436315_8432829112128634880_n.png",
        "6a7978c-21274929_1469790786436315_8432829112128634880_n.png",
        "Screenshot of m.me Link."
      ],
      "align": "center",
      "sizing": "150px",
      "border": true,
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Messenger Code",
    "0-1": "You can make the QR codes of your webpage available on Facebook Messenger so that the users can directly scan the codes from the mobile app to start a conversation.  \n  \n**Image Size**:  the size of the QR code image in pixels  \n  \n**Add Referral Payload**: enable this to add a payload for the QR code. Enter the payload in the **Ref Payload** field. You can generate different messenger codes with different referral payload. The referral payload is part of the first message the user scans the code. You can use this to track referral code traction or you can use to activate different journey for different Messenger code scan.",
    "1-0": "Messenger Link",
    "1-1": "Your messenger link is a shortened URL that people can use to go directly into a Messenger conversation."
  },
  "cols": 2,
  "rows": 2,
  "align": [
...
3. If you deselect any of the integrated pages when adding a new page in the <<prodname>> platform. Make sure to include all the integrated pages.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/ccc3787-Facebook_login_flow.png","Facebook login flow.png","Screenshot displaying of List of Messenger Page."],"align":"center","sizing":"smart","border":true,"caption":"Screenshot displaying of List of Messenger Page."}]}[/block]
...
2. Click **Reauthorize Page** to relink the page from the Webex Connect platform from the messenger page settings.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/e8439bf17e1f23198c6e2508532a87efbee0ddb2436fe74cd28a2b8c6a5d2a82-image.png",null,"Screenshot of Click Reauthorized on Reauthorize Page"],"align":"center","border":true,"caption":"Reauthorize Page"}]}[/block]
3. Click **Reauthorize **to confirm the reauthorization of the Messenger page.

   [block:image]{"images":[{"image":["https://files.readme.io/e19d3ab619b4068f9611d0e89b0ab4f052ad0881a9dd38183a4d3d3e1297c1c6-image.png",null,"Screenshot of Click Reauthorize Messenger Page."],"align":"center","sizing":"70% ","border":true,"caption":"Reauthorize- Messenger Page"}]}[/block]
4. Select Messenger Page, which appears with an auto-selected page from the list, and click **Next**.

   [block:image]{"images":[{"image":["https://files.readme.io/090b549fc083c425fd9b8c04f5bc783e3cf17d8dc90afb314aa74bf660136d73-image.png",null,"Screenshot of Select Messenger Page."],"align":"center","border":true,"caption":"Select Messenger Page- Confirm"}]}[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Screenshot of Manage Facebook Messenger app asset"
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4dad07ff7b5588d5b765c05d3842cc50a927bce387a195528695a72bafda66a3-Facebook_Messenger_app_asset.png",
        "",
...
Once a Facebook Messenger app is configured, you can configure [Outbound Webhooks](doc:outbound-webhooks) by choosing the Facebook Messenger app from the entity dropdown to receive incoming messages and events from your customers.
...
To receive delivery receipts of the messages you sent out, configure [Outbound Webhooks](doc:outbound-webhooks) on the service from which you sent the message.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8507c37-facebook-generic-template.png",
        "facebook-generic-template.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/65ddf3a-dd93a72-facebook-button-template.png",
        "dd93a72-facebook-button-template.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6a5258e-68747470733a2f2f636c61756469616a732e636f6d2f6173736574732f66616365626f6f6b2f726563656970742e706e67.png",
        "68747470733a2f2f636c61756469616a732e636f6d2f6173736574732f66616365626f6f6b2f726563656970742e706e67.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dd68181-Xbb3k.png",
        "Xbb3k.png",
        "Screenshot of Quick Replies."
      ],
      "align": "center",
      "border": true,
...
[block:parameters]
{
  "data": {
    "h-0": "Channel Events",
    "h-1": "Actions",
    "0-0": "_ Incoming message  \n  _ On link click  \n  _ Postback  \n  _ Profile creation  \n  \\* Profile update",
    "0-1": "_ Send Messenger Message  \n_ Invoke a Flow  \n\\* Forward to BOT"
  },
  "cols": 2,
  "rows": 1,
  "align": [
...
In flow, you can configure the [Receive](https://help.imiconnect.io/docs/receive) node to receive messages from a Facebook page and the [Messenger](doc:messenger) node enables you to send messages on to Facebook end-user.
