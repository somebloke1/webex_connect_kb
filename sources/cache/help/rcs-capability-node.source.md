...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/78f4539-RCS.jpg",
        "RCS Capability Node Configuration Window.png",
        "Screenshot of RCS Capability Node."
      ],
      "align": "center",
      "border": true,
      "caption": "RCS Capability Node"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/22033f2-RCS1.jpg",
        "rcs_capability_config.png",
        "Screenshot of RCS Capability Node Configuartion Window."
      ],
      "align": "center",
      "border": true,
...
You can see the data that this node generates as output variables. These [variables](doc:variable-management) are available for use in subsequent nodes. The following are the standard output variables for the RCS capability node:
