<<prodname>> offers a rich and intuitive AI Agent Studio to configure agents to automate responses to standard customer queries and configure Task bots to fulfil customer requests without manual intervention. 

The description below covers how you can use bots configured using <<prodname>> Bot Builder within the visual flow builder to automate handling of customer requests before escalating it to Webex Contact Centre agents, if needed.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/35ab2fe-Task.jpg",
        "Picture1.png",
        ""
      ],
      "align": "center",
  ...
  "images": [
    {
      "image": [
        ...
        null,
        "Using the values extracted from Data Parser in Messenger node"
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a33b529-QnA.jpg",
        "Picture10.png",
        602
      ],
      "align": "center",
      "caption": "Using Name and Email values collected in pre-chat form and sending them to the bot as Customer Parameters"
    }
  ]
}
[/block]
