This node calls imengage RemoveParticipant API to remove an agent from the conversation on imiengage. While configuring flows in <<prodname>>, you’d need to use this node for removing the agent from the conversation. The agent details will be available from the “Modified event “.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5dafd5b-Remove_Paticipant.jpg",
        null,
        "Screenshot of Removing a participant configuration page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Removing a participant configuration page."
    }
  ]
}
[/block]
