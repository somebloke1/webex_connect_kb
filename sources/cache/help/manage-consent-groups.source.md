...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0e9a569-Manage_Consent_Group.png",
        "",
        "Snapshot of Management Consent Group Page"
      ],
      "align": "center",
      "border": true,
      "caption": "Snapshot of Management Consent Group Page"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/66b033710afb9c1e782d733af2396ef4d932f83e908db66c4eafa1958dc030a0-image-20240802-151730.png",
        null,
        "Screenshot of upload history"
      ],
      "align": "center",
      "border": true,
      "caption": "Manage Consent Group - Upload History Tab"
    }
  ]
}
[/block]
...
3. In the Management Consent Group page for the specific group, click **Upload Records**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/9950bf3ceb96c499530ffccf37928be5f34743d90402ee407e786d532a14519e-c0771694-fd6a-47fa-8e3f-79f07756fb63_1.png","","Screenshot of Upload Records tab on Manage Consent Group page"],"align":"center","border":true,"caption":"Manage Consent Group - Upload Records Tab"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d293c621753adbc424a0ba15f07dea9939eb2c330cc2236af0c7cdd305665646-image-20250908-085329.png",
        "",
        "Screenshot of sample of a Downloaded CSV file"
      ],
      "align": "center",
      "border": true,
      "caption": "Sample of a Downloaded CSV file"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    "h-0": "Error Message",
    "h-1": "Description",
    "h-2": "File Upload Status",
    "0-0": "Mandatory field missing",
    "0-1": "A required field has not been set",
    "0-2": "Failure",
    "1-0": "Address invalid for channel type",
    "1-1": "Validation on the address for the specified channel did not pass (E.164 standard for phone number or email)",
    "1-2": "Failure",
    "2-0": "Invalid format for a field",
    "2-1": "Different possible errors, mainly if the group does not support the provided channel or invalid date, etc.",
    "2-2": "Failure",
    "3-0": "Duplicate record ignored",
    "3-1": "The record already exists for the address, and the 'Update existing policy' option was not selected",
    "3-2": "Failure",
    "4-0": "Unknown error saving row",
    "4-1": "Unable to save to the database. Try uploading the file once again after some time.",
    "4-2": "Failure",
    "5-0": "Row can not be parsed",
    "5-1": "Unable to read the record from the .csv file. Try uploading the file once again after some time.",
    "5-2": "Failure",
    "6-0": "Created successfully",
    "6-1": "Successfully added the record to the group",
    "6-2": "Success",
    "7-0": "Updated successfully",
    "7-1": "Successfully updated an existing record for the group",
    "7-2": "Success",
    "8-0": "Invalid alternate address",
    "8-1": "The alternate address provided for the WhatsApp record is not valid.",
    "8-2": "Failure",
    "9-0": "Duplicate alternate address ignored",
    "9-1": "The alternate address already exists for the record, and the update option was not selected.",
    "9-2": "Failure",
    "10-0": "Conflicting alternate address",
    "10-1": "The uploaded record attempts to replace an existing alternate address or BSUID mapping, but `replaceAlternateAddress` is not set to `true`.  \nSet `replaceAlternateAddress` to `true` to replace the existing BSUID mapping.",
    "10-2": "Failure"
  },
  "cols": 3,
  "rows": 11,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2d6b07a-Delete_Consent_Group_Confirmation.jpg",
        null,
        "Image showing a confirmation dialog asking the user to confirm the action by clicking the Delete button."
      ],
      "align": "center",
      "sizing": "400px",
      "border": true,
      "caption": "A confirmation message displayed with a prompt to click Delete"
    }
  ]
}
[/block]
...
4. Click **Save**
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/67355fe49da5058ae1ff5f397c714bbda6029cdf2e51e957b450eeed33ded824-Contact_Policy_Picture1.png","","Contact Policy- Full Access"],"align":"center","border":true,"caption":"Contact Policy—Full Access"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3aaa7c4d351b758815d0e57300c43511b4dd9f44b4ecb2087c2dc1994c604a9e-image-20250609-053832_1.png",
        null,
        "A screen showing a list of consumer records."
      ],
      "align": "center",
      "border": true,
      "caption": "Image displaying a list of consumer records"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7b039b6-Delete_User_Consent1.png",
        null,
        "Image showing a confirmation dialog asking the user to confirm the action by clicking the Delete button."
      ],
      "align": "center",
