...
Source: https://help.webexconnect.io/docs/limitations-and-faqs
...
**How long does it take to create my brand once the request is submitted?**

The standard timeline for creation of the Brand is less than 24 hours.

**How long does it take to approve my campaign once submitted?**  
Standard use case Campaigns are approved between 1 - 2 business weeks for qualified brands, while some Special use case Campaigns are dependent on MNO review times. These Campaigns initially will be in a “Pending” Status upon completion of the registration process. Once the Campaign is accepted, the registered tenant owner will be notified and the status can be verified in the Campaigns page.
...
**How long does it take to purchase and provision a 10DLC?**

For the customers using the ‘Buy Number’ option available on Webex Connect, It takes less than a minute to purchase a number and less than 5 minutes to provision the 10DLC number. For the customers who want to use external numbers or numbers which are not owned by Cisco, a request must be placed with Webex Connect Customer Support team and it could take upto 3-7 business weeks on an average.