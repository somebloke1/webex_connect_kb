...
The generate OTP node allows you to generate a dynamic one-time password for authentication purposes. <<prodname>> sends OTPs to users over SMS/Voice/Email/Push Notifications or other supported channels. The generate OTP node and [validate OTP](doc:validate-otp) node are often used in conjunction to set up user authentication flows such as two-factor authentication.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ef9fe6b-generate_otp_icon.png",
        "generate_otp_icon.png",
        "Screenshot of Generate OTP Node"
      ],
      "align": "center",
      "caption": "Generate OTP Node"
    }
  ]
}
[/block]
...
1. Select an **OTP Format**. The default format is _Alphanumeric_. <<prodname>> supports the following OTP formats:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ac3a083-Generate_OTP_Node_Generate_OTP_Configurations.png",
        "Generate OTP Node Generate OTP Configurations.png",
        "Screenshot of Generate OTP Configuration Page."
      ],
      "align": "center",
      "caption": "Generate OTP Configuration"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c4634e1-generate_otp_input_variables.png",
        "generate_otp_input_variables.png",
...
You can see the data that this node generates as output variables. These [variables](doc:variable-management) are available for use in subsequent nodes. The following are the standard output variables for the generate OTP node:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f69b2e-generate_otp_output_variables.png",
        "generate_otp_output_variables.png",
...
[block:parameters]
{
  "data": {
    ...
    "0-1": "\\* **onSuccess** - the flow exits through this node when an OTP is generated successfully.",
    "1-0": "Error (red)",
    "1-1": "\\* **onError** - the flow exits through this node outcome when the OTP generation request could not be processed due to invalid input."
  },
  "cols": 2,
  "rows": 2,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e28dab5-Generate_OTP_Node_Node_Outcomes.png",
        "Generate OTP Node Node Outcomes.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/114d6d5-Generate_OTP_Node_Sample_Configuration_of_Generate_OTP.png",
        "Generate OTP Node Sample Configuration of Generate OTP.png",
        "Screenshot of Sample Configuration of Generate OTP."
      ],
      "align": "center",
      "caption": "Sample Configuration of Generate OTP"
    }
  ]
}
[/block]