...
Source: https://help.webexconnect.io/docs/call-workflow-node
...
![Call workflow Node](https://files.readme.io/0630546-Call_Workflow.png)
...
![Call Workflow Node Configuration Page.](https://files.readme.io/798ef79-Call_Workflow_Click_the_image_to_view_it_larger.png)
...
| --- | --- | --- |
| 1 | Configuration tab | Use this tab to configure the workflow that you wish to call.  <br>  <br>Field descriptions:  <br>  <br>**WORKFLOW NAME**  <br>Select the workflow that you wish to call.  <br>  <br>**NODE TYPE**  <br>Select from the following options: **All, Start **and **End**.  <br>  <br>**Note:** If you select **All**, then both **Start **and **End** are selected.  <br>  <br>**NODE NAME**  <br>From this drop-down box, select the node name. |
