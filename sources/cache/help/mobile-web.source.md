The <<prodname>> iOS and Android SDKs provide a messaging framework for mobile app developers to integrate <<prodname>>'s Push and Live Chat/InApp messaging services into their mobile applications.
...
> 📘 
> 
> <<prodname>> does not support local notifications.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a1b46cd3277b194581919cc5211d9b099875870b9a054265d0d666c479adafb6-image.png",
        null,
        "Screenshot of SDK Configuration Files to download Android,iOS and JavaScript SDKs."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of SDK Configuration Files"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e691d0dcc19a0bfbab09f071db35d8db4296dde472cf16282f261ed3decaf6ab-image.png",
        null,
        "Screenshot of enabling Web Push Notifications generates updated imi-environment.js"
      ],
      "align": "center",
      "border": true,
      "caption": "Enabling Web Push Notifications generates updated imi-environment.js"
    }
  ]
}
[/block]
...
The app asset configuration page has been updated to allow downloading the complete config file required for initializing <<prodname>> mobile SDKs (Android, iOS and Web SDKs). App developers can now directly embed the downloaded config file in their app code.
...
[block:parameters]
{
  "data": {
    "h-0": "iOS",
    "h-1": "Android",
    "0-0": "_ [Setup Your Project](https://developers.imiconnect.io/docs/quickstart-guide-2)  \n_ [Setup APNs](https://developers.imiconnect.io/docs/setup-apns-for-safari-browser)",
    "0-1": "[Setup Google Cloud Messaging (FCM)](https://developers.imiconnect.io/docs/setup-fcm-for-chrome-and-firefox-browsers)"
  },
  "cols": 2,
  "rows": 1,
  "align": [
...
To add a mobile/web application in <<prodname>>:
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Name ",
    "0-1": "Enter a name for the mobile application.",
    "1-0": "Access Credentials",
    "1-1": "Access credential is used to uniquely identify the app while communicating with <<prodname>>.",
    "2-0": "Client Key",
    "2-1": "The client key is auto-populated. This key along with _App ID_ is used to initialize the SDK.",
    "3-0": "Push Notifications",
    "3-1": "Configure your push provider's credentials here to allow <<prodname>> to send notifications to your app users. Read our SDK quick start guides to know more.  \n  \n  _ [**iOS**](#section-apple-firebase-cloud-messaging-fcm)  \n  _ [**Android**](#section-android-configure-push-notifications)  \n  _ [**Chrome and Firefox**](#section-chrome-and-firefox-web-configure-push-notifications)  \n  _ [**Safari**](#section-safari-web-configure-safari-push-notifications)",
    "4-0": "Live Chat/ In App Messaging",
    "4-1": "Configure Live Chat / InApp messaging",
    "5-0": "**Advanced Settings**",
    "5-1": "",
    "6-0": "JWT Authorization",
    "6-1": "Configure JWT authorization to provide JWT secret key",
    "7-0": "Server Side Inbox",
    "7-1": "Allows the storage of data on server of <<prodname>>. By default it is enabled for all the existing tenants. Only a tenant owner, a full access user, or a limited access user can enable or disable the option.  \n  \nWhenever you try to disable this option, a popup with the following message is displayed. You must click **confirm** to enable.  \n  \n  \\_ Once server side inbox is enabled, all new messages will have a server side copy for future downloads.  \n  \nWhenever you try to disable this option, a popup with the following message is displayed. You must click **confirm** to disable.  \n  \n  \\_ Once Server Side Inbox is disabled, new messages are not stored on server side. These messages will be delivered only once and post that, you must maintain a copy of these messages on your server for future reference.  \n  \nThe Server Side Inbox option is disabled by default. You must enable the option if you want to use the capability.",
    "8-0": "Allow Multi User Registrations on Same Device",
    "8-1": "Allows multiple users on the same device for the application",
    "9-0": "Single Device Per User",
    "9-1": "Restricts access to the application to one user per device. If you register on a new device, you will stop receiving push notifications on the older device.  \n  \nYou can enable this feature at an app asset level from mobile/web app asset configuration screen."
  },
  "cols": 2,
  "rows": 10,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c6bb2e5-3.jpg",
        null,
        "Screenshot of Enabling Device Per User"
      ],
      "align": "center",
      "border": true,
      "caption": "Enabling Single Device Per User"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/637158f-2.jpg",
        null,
        "Screenshot of Enabling Multi User Registrations on Same Device"
      ],
      "align": "center",
      "border": true,
      "caption": "Enabling Multi User Registrations on Same Device"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    "h-0": "Field",
    "h-1": "Description",
    "0-0": "Certificate Password",
    "0-1": "Certificate password of the APNS.",
    "1-0": "APNS Type",
    "1-1": "Select the Gateway (production/sandbox).  \nIf you have created Apple Push Notification service SSL for Sandbox, then select Sandbox from the drop-down.  \nIf you have created Apple Push Notification service SSL for Production, then select Production from the drop-down.",
    "2-0": "Drag-and-drop or choose the APNS Certificate file",
    "2-1": "Select the APNS file you have created.",
    "3-0": "Permissions",
    "3-1": "Set of permissions that you need to add to the app."
  },
  "cols": 2,
  "rows": 4,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Key ID",
    "0-1": "The Key ID from Apple Developer Account",
    "1-0": "Team ID",
    "1-1": "The Team ID from Apple Developer Account",
    "2-0": "Package",
    "2-1": "An identifier of the topic of the app to which the notifications will be pushed",
    "3-0": "Gateway",
    "3-1": "The gateway to use for push notifications:  \n   _ Sandbox  \n   _ Production",
    "4-0": "Drag and drop or choose the APNS Certificate file",
    "4-1": "Select the APNS private key file specific to the app.",
    "5-0": "Permissions",
    "5-1": "Set of permissions that you need to add to the app."
  },
  "cols": 2,
  "rows": 6,
  "align": [
...
| HMS                                  | Huawei Mobile Services (HMS) App ID and App secret allow <<prodname>> to submit push notifications to your application. For more information, refer to [Quickstart guide](https://developers.imiconnect.io/docs/quickstart-guide-2#capture-the-huawei-app-id-and-app-secret).              |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/21b84d3-4.jpg",
        "2021-07-14_14-51-17.jpg",
        "Screenshot of Configure Chrome and Firefox Push Notifications."
      ],
      "align": "center",
      "sizing": "400px",
      "border": true,
      "caption": "Screenshot of Configure Chrome and Firefox Push Notifications."
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    "h-0": "Field",
    "h-1": "Description",
    "0-0": "Primary Transport Protocol",
    "0-1": "Message delivery primary transport protocol  \n_ MQTT  \n_ Web Socket",
    "1-0": "Secondary Transport Protocol",
    "1-1": "Message delivery secondary transport protocol. This protocol is used when the primary protocol fails to deliver the message.  \n_ MQTT  \n_ Web Socket",
    "2-0": "Use Secured Port",
    "2-1": "Secured ports to ensure RTM connections are established over a secured protocol for better security.  \nIf enabled, <code>8883</code> is used for MQTT and <code>8884</code> for Web Socket.",
    "3-0": "Enable Payload Encryption",
    "3-1": "Choose to use AES encryption to encrypt the in-app messaging payload for enhanced security."
  },
  "cols": 2,
  "rows": 4,
  "align": [
