<<prodname>> makes it easy for you to automate customer interactions across 10+ channels by providing a drag-and-drop flow builder. It does away with the need to write complex programs and to go through the traditional software development lifecycle.  

Here are the key steps for automating a customer interaction using <<prodname>>:
...
d. Navigate to the service you created in the last step. Build and launch the communication flow using <<prodname>> visual flow builder. Refer the navigation guide for Flow Builder [Navigating Flow Builder Canvas.](https://help.imiconnect.io/docs/flow-interface).
...
b. The next step is to integrate any required backend enterprise systems with <<prodname>>. For example, you can integrate your CRM system with <<prodname>> to fetch the appointment details. (_We recommend skipping this step to keep the things simple for the first time user_)

c. Create a [new service](https://help.imiconnect.io/docs/create-a-service-on-imiconnect).

d. Configure and deploy the desired communication flow using <<prodname>> [visual flow builder](https://help.imiconnect.io/docs/sending-automated-sms-using-imiconnect-visual-flow-builder).
...
The use cases listed below offer a hands-on experience for developing end-to-end customer journeys using <<prodname>>.

| S. No. | Title                                                                                                                                                               |
| :----- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1      | [How to configure a Two Factor Authentication on <<prodname>>?](https://help.imiconnect.io/docs/how-to-configure-two-factor-authentication-on-imiconnect)           |
