<<WebexCC>> users who want to use <<AMB>> as a channel of customer support with Webex Contact Center can easily register their Messages for Business account on <<prodname>> by following the procedures on this page.

## Create an Apple Messages for Business Application

A Messages for Business application is automatically created within <<prodname>> when you register on the [Apple Business Register](https://register.apple.com/business-chat) to create a Messages for Business account and choose <<prodname>> as your messaging service provider (MSP).
...
Once your business account is approved, choose <<prodname>> as your MSP platform
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fe4b166-2024-01-10_13-54-57.jpg",
        "693ec95-Screenshot_2018-10-25_at_17.00.41.png",
        "Screenshot of Customer Service Platform Configuration on Apple Business Register."
      ],
      "align": "center",
      "border": true,
      "caption": "Customer Service Platform Configuration on Apple Business Register"
    }
  ]
}
[/block]
...
You need an <<prodname>> account to complete the linking process. Once successfully linked, you will find your business account under Apps in your <<prodname>> account.

> 📘 Note
> 
> If you do not have an <<prodname>> account, register for a free trial on [our website](https://imimobile.com/products/imiconnect) and wait for the approval which takes about 2 hours on a business day.

## Using the channel

### User Identity

To message users on <<AMB>> (AMB), you will need the <code>abcId</code> of the users. You will receive this when the customer messages the business account for the first time.
...
<<AMB>> on <<prodname>> supports the following message types:
...
<<AMB>> enables you to provide customers with the option to buy products and services using Apple Pay without leaving the conversation. Customers can respond to the payment request using their preferred Apple Pay payment methods. 
...
4. Enable **Payment** toggle and provide the following details that you have obtained here: _Merchant ID_, _Merchant Name_, _Domain Name_  as shown below
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/cac4c2c-image.png",null,"Screenshot of Enable Payment"],"align":"center","caption":"Enable Payment"}]}[/block]
...
Once the above steps are configured, you can start using flow nodes to send Apple Pay requests and wait for payment responses to configure your customer journeys. For more information, refer to instructions on [configuring Apple payment](https://help.imiconnect.io/docs/apple-messages-for-business#configuring-a-payment).
  ...
  "images": [
    {
      "image": [
        ...
        "Screenshot of Apple Busisness Register"
      ],
      "align": "center",
      "sizing": "smart",
      "caption": "Apple Business Register"
    }
  ]
}
[/block]
...
- You must have an [<<AMB>> account](https://developers.imiconnect.io/reference/apple-business-chat-faqs#registration-for-apple-messages-for-business)

- **OAuth authorization endpoint, OAuth token endpoint, OAuth client ID -** These details need to be entered in your <<AMB>> account within Apple Business Register. These details will be provided by your OAuth provider. The example below demonstrates the setup using LinkedIn’s OAuth service.
  ...
  "images": [
    {
      "image": [
        ...
        "manage_app_ABP.png",
        "Screenshot of Enable Authentication"
      ],
      "align": "center",
      "sizing": "smart",
      "border": true,
...
Once your authentication configuration is setup on both Apple Business Register and <<prodname>>, you can start using it in a flow. For more information, refer to [configuring authentication](https://help.imiconnect.io/docs/apple-messages-for-business#configuring-a-new-authentication).
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Screenshot of Add Preview For Domain"
      ],
      "align": "center",
      "border": true,
      "caption": "Add Preview For Domain"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Screenshot of Choosing File to upload the image"
      ],
      "align": "center",
      "border": true,
      "caption": "Choose File to upload the image"
    }
  ]
}
[/block]
...
2. Select <<AMB>> from the App Type dropdown.

3. Select the required <<AMB>> channel for which you want to register with Webex Engage.

   [block:image]{"images":[{"image":["https://files.readme.io/0dce53c-11.png",null,"Screenshot displaying list of Apple Messages for Business Assets"],"align":"center","border":true,"caption":"Apple Messages for Business"}]}[/block]

4. In **Manage App - Apple Messages for Business** page, click **Register to Webex Engage**.

   [block:image]{"images":[{"image":["https://files.readme.io/53ab16d-Manage_App_AMB.png",null,"Screenshot of Register to Webex Engage"],"align":"center","caption":"Register to Webex Engage"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/386b61f-Screenshot_2024-06-07_at_4.18.42_PM.png",
        null,
        "Screenshot of Register to Webex Engage pop-up"
      ],
      "align": "center",
      "sizing": "300px",
      "border": true,
      "caption": "Register to Webex Engage pop-up"
    }
  ]
}
[/block]
...
5. Select the required service (this should be the <<prodname>> service that would be used for configuring Apple Messages for Business flows for Webex Contact Center) and click **Register**.  
   The message "Asset registered successfully" is displayed.

As shown above, you will see a Webex Engage icon and a PCI check-enabled flag next to the App name once it's been successfully mapped with <<WebexCC>>.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e8c102f-AMB-Apps.png",
        null,
        "Screenshot displaying PCI icon"
      ],
      "align": "center",
      "border": true,
      "caption": "Webex Engage icon and PCI icon"
    }
  ]
}
[/block]
...
You can configure Outbound Webhooks by choosing the <<AMB>> app from the entity dropdown to receive incoming messages and events from your customers.

Once you have registered and configured on the <<AMB>> and selected <<prodname>> as your preferred service provider.
