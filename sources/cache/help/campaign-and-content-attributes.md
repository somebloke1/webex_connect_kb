...
Source: https://help.webexconnect.io/docs/campaign-and-content-attributes
...
This field specifies how a user signs up or provides their consent to receive messages for the text messaging campaign. Following are the prerequisites for enabling the customer sign-up with the company/brand.
...
> 
> Brand name & message types [brand name and the campaign category], how to opt in <text keyword to number or enter your number on the web form>, Message frequency disclosure \<recurring messages or one-time/transactional messages>, Message and data rates may apply. View Terms & Privacy here: (Customer URL link for Terms & Conditions link and Privacy Policy)
...
> 📘 Note
> 
> For more information, refer to [Campaign and Content Attributes](https://help.imiconnect.io/docs/campaign-and-content-attributes).
...
[X Brand Program Name] Need help? Call us at (XXX) XXX-XXXX or email us at: [support@brandname.com.](mailto:support@brandname.com.) Reply STOP to end.
...
Provide the URL where the Terms & Conditions reside. _If the URL does not have the required SMS verbiage live, a mockup of what the verbiage will look like must be provided._
...
[X Brand] text notifications on [code], Message and Data Rates May Apply. Reply STOP to stop. Reply HELP for info or email us at [support@xxxxx.com.](mailto:support@xxxxx.com.) View our Privacy Policy here [URL]
