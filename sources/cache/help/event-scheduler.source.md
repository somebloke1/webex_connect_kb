Event Scheduler allows <<prodname>> to schedule outbound messages to be sent to your customers as per the configured time schedule. You can send SMS messages or schedule future invocations of <<prodname>> rules/live flows simply by uploading a file (on the UI or via an SFTP location) with required information in the relevant format. 
...
> 🚧 Limitations
> 
> - <<prodname>> Event scheduler can process file sizes of up to 75 MB. Also, the file name of the uploaded file should be less than 75 characters in length. Not subscribing to these limits can lead to schedule failure during execution.
> 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f70116-11.jpeg",
        "event scheduler.PNG",
        "Screenshot of the Event Scheduler page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of the Event Scheduler page."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/73ab0c9-Event_Scheduler1.jpg",
        "App Tray Event Scheduler Create a Schedule.png",
        "Screenshot of Creating the Schedule"
      ],
      "align": "center",
      "sizing": "500px",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c7b25be10da1597222b9b05d10c634e1aac3402340a3442dbf14f415ef22023f-2025-11-18_13-05-49.png",
        "Create Schedule-Custom.jpg",
        "Screenshot of creating the Custom Events"
      ],
      "align": "center",
      "sizing": "700px",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cf92f47-Event_Scheduler2.jpg",
        "SFTP Screen.jpg",
        "Screenshot of creating the Custom Events"
      ],
      "align": "center",
...
6. **Using Upload File Option**: The Total Rows field displays the total number of rows available in the spreadsheet including the number of Valid Rows, Invalid Rows, and Duplicate Rows. This populates/shows up when a file is uploaded in the "Upload a file" option.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/7e0dd66ebc934b187366c361345dd0aaf78ad344ff37f86543e35395985c5b8f-2025-09-16_18-27-34.png","","Screenshot of the sample file format using Upload File Option"],"align":"center","border":true,"caption":"Sample File Format"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/389b53c-ES2.jpg",
        "2022-03-31_22-20-04.jpg",
        "Image showing the interface section where users can select the Upload File option under Target data"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the Upload File option under Target data."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cd36c82-ES3.jpg",
        "2022-03-31_15-15-40.jpg",
        "Image showing the interface section where users can select the SFTP option under Target data"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the Upload SFTP option under Target data."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3aeda73-Event_Scheduler3.1.jpg",
        "ES_Basic_details.png",
        "Interface displaying the Basic Details page for creating a schedule."
      ],
      "align": "center",
      "sizing": "500px",
      "border": true,
      "caption": "Create Schedule - Basic Details"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9dc66c7-Event_Scheduler4.jpg",
        "ES_eventfrequency.png",
        "Screenshot of selecting the Event Frequency"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of selecting the Event Frequency"
    }
  ]
}
[/block]
...
15. You can select from one of the following execution patterns for running the schedule:
    ...
    3. **Hourly:** the hourly allows to set the frequency however many times you want per hour.
       ...
       3. Select one of the from the **End** dropdown:
          ...
          [block:image]{"images":[{"image":["https://files.readme.io/074a479-Event_Scheduler5.jpg","","Image showing the interface where the frequency option is set to run the schedule on an hourly basis."],"align":"center","border":true,"caption":"Screenshot of selecting frequency to run the schedule hourly"}]}[/block]
       ...
       6. **Expression:** the event trigger can be customized as per the requirement entering expression. 
          ...
          3. **On** the trigger stops at the entered **End Date** and **End Time**.
             ...
             [block:image]{"images":[{"image":["https://files.readme.io/17d15d5-2.jpg","","Interface showing options to customize the event trigger by entering a specific expression according to requirements"],"align":"center","border":true,"caption":"Screenshot of selecting the Expression triggers."}]}[/block]
...
18. From the **Select Execution TPS** dropdown list, select the required TPS. The TPS ranges from 1 to 50. Using this option, you can configure the transactions per second (TPS) limit for various Messaging/Event API invocation schedules configured through the event scheduler. Overall, the TPS is subject to a maximum of the Messaging API and Event API TPS limits of your <<prodname>> account. Also, the configured TPS is the max TPS at which platform makes an attempt to execute your Event Schedule. However, it is subjected to the available TPS at any given point in time. When Event Scheduler encounters maximum transaction limit reached i.e., 7020 scenario (this may occur if your <<prodname>> tenant is being used for processing other communications while the Event Scheduler is running in parallel), it automatically retries until the TPS becomes available. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/15386e5-Event_Scheduler6.jpg",
        "tps_event_scheduler.png",
        "Screenshot of selecting the Execution TPS"
      ],
      "align": "center",
      "border": true,
      "caption": "Select Execution TPS"
    }
  ]
}
[/block]
...
20. **Using Consent Group Option : **Select **Consent Group**.
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/d18d46149d5b5e3849cfa9325453bd72a926802d52f67a4e257449f48ed382ae-image.png",null,"Screenshot displaying the Consent Group option under Target data"],"align":"center","caption":"Screenshot displaying the Consent Group option under Target data"}]}[/block]
...
> 
> When you configure a schedule using Event Scheduler, <<prodname>> generates a unique Correlation ID and uses it as the correlation id for every message sent using this Schedule whether it's a direct outbound SMS schedule, or a custom event trigger based schedule. However, you can use a different Correlation ID in the channel specific Send Node if you want to user a different value.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ad556da-App_Tray_Event_Scheduler_SMS.png",
        "App Tray Event Scheduler SMS.png",
        "\"Screenshot of creating a schedule for the SMS channel"
      ],
      "align": "center",
      "caption": "Screenshot of creating a schedule for the SMS channel"
    }
  ]
}
[/block]
...
8. On successful file upload (through either input type) or consent group selection, do the following:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/20cdc9a-2.jpg","","Screenshot displaying the Upload File option under Target data."],"align":"center","border":true,"caption":"Screenshot displaying the Upload File option under Target data"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e4078a-Event_Scheduler8.jpg",
        "",
        "Image showing the Event Scheduler list page, highlighting the newly added SMS event schedule among other scheduled events"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of the Event Scheduler list page with the added SMS event schedule"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/01661be-Event_Scheduler9.jpg",
        "2022-03-31_22-32-45.jpg",
        "Screenshot displaying the list of SFTP configurations"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the list of SFTP configurations"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/49abc96-2022-03-31_22-35-27.jpg",
        "2022-03-31_22-35-27.jpg",
        "Image showing the interface for setting up an SFTP configuration."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of creating an SFTP configuration."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/abf22b5-Event_Scheduler10.jpg",
        "Socialhour.png",
        "Image displaying the interface for configuring social hours."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of setting Social Hours"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c0c6cd2-error_email.png",
        "error_email.png",
        "Image showing an email alert stating that the execution of a scheduled trigger has failed."
      ],
      "align": "center",
      "caption": "Screenshot of email notification indicating that scheduled trigger execution has failed"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4818448-Event_Scheduler11.jpg",
        "ES_logs.png",
        "Screenshot displaying a list of Event Scheduler Logs"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying a list of Event Scheduler Logs"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Search",
    "0-1": "Enter a keyword to search a log.",
    "1-0": "Schedule Type Filter ",
    "1-1": "Select the event from the dropdown for which the logs are required to be generated. Options include All Events, SMS or Custom Event.",
    "2-0": "Select Period",
    "2-1": "Use the dropdown to select the required time period to view the logs.  \n  \nYou can also select custom date and time.  \n  \nNote: Logs are saved only for 6 months. So you cannot select the start date which is more than 6 months ago in the Custom filter.",
    "3-0": "Type",
    "3-1": "Signifies the event type, for example, SMS.",
    "4-0": "Name",
    "4-1": "Event scheduler name.",
    "5-0": "Service",
    "5-1": "Service to which the event being scheduled belongs.",
    "6-0": "Time",
    "6-1": "Date and time corresponding to the status of the event.",
    "7-0": "Total Entries",
    "7-1": "Displays the number of but the number of records that will be processed.",
    "8-0": "Processed Entries",
    "8-1": "DDisplays the number of successfully processed entries.",
    "9-0": "Errors (I/D)",
    "9-1": "Lists the number of Invalid or Duplicate IDs.",
    "10-0": "Status",
    "10-1": "Displays the trigger status, for example: Started, Processed or Error. The information icon associated with the Error status displays the error message.",
    "11-0": "Error Report",
    "11-1": "Downloadable report in csv format, that lists the errors/failed transactions. The report contains the following information:  \n  \n·      List of rows that were not processed  \n  \n·      Reason of failure and the details along with the transaction id  \n  \nNote: The download button is not visible if the errors in the Errors (I/D) column in 0/0. It is available only in case of processing errors."
  },
  "cols": 2,
  "rows": 12,
  "align": [
