...
Source: https://help.webexconnect.io/docs/wxcc-handling-various-customer-intents-bot-builder-wxcc
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:29:18+00:00

This document covers how you can branch your flow to automate handling of various customer requests/intents when using Webex Connect Bot Builder and bot nodes within flows.

## Branching flows based on bot variables and fulfilling customer requests

**Use-case**

Using bot nodes, Webex Connect can detect different user intents in natural language. Based on these intents, different logic can be executed in the flow to provide appropriate fulfillment. In this example, the bot allows customers to:
...
![Visual representation of the complete flow for booking an appointment,](https://files.readme.io/8ba7add-Picture12.png)
...
![Initialising a variable in Messenger start node that can be used for incoming messages throughout the conversation](https://files.readme.io/7f4fe8d-Picture11.png)
...
![Configuring Task Bot Node with Message Variable.](https://files.readme.io/968a5c8-Picture13.png)
...
![Branching Using Task Bot Intent Output.](https://files.readme.io/cb9e434-CISCO_WEBEX_CONTACT_CENTER__IMICONNECT_INTEGRATION_Handling_various_customer_intents_using_flows_and_Bot_Builder_Branch_Node.png)
...
![ Appointment Booking Flow](https://files.readme.io/4724a6c-Picture15.png)
...
![Extracting entity values using data parser node](https://files.readme.io/bbff0e7-Picture16.png)
...
![Posting Booking Details with HTTP Node](https://files.readme.io/22e4cac-Picture17.png)
...
![Extracting quick reply button titles and payloads along with text response](https://files.readme.io/cce4910-Picture18.png)
...
![Using the values extracted from Data Parser in Messenger node](https://files.readme.io/69ca73e-Picture19.png)
