...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5e030ed-20.jpg",
        "integartion_navigation.png",
        "Screenshot showing navigation to the Integrations screen via Assets menu."
      ],
      "align": "center",
      "sizing": "200px",
      "border": true,
      "caption": "Navigate to the Integrations screen by selecting Integrations from the Assets menu."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cdf7c8e-21.jpg",
        "add_integration.png",
        "Screenshot of clicking the ADD INTEGRATION button and selecting CUSTOM NODE."
      ],
      "align": "center",
      "border": true,
      "caption": "Adding a custom node by selecting it from the ADD INTEGRATION drop-down menu."
    }
  ]
}
[/block]
...
Once you click the Custom Node option, a 'Create new custom node' pop-up appears as shown below. As you would notice, <<prodname>> enables you to integrate with both Rest API and Soap API compliant systems. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f0027fc-Custom_Node1.jpg",
        "Custom Node Integration 3.png",
        "Screenshot of the 'Create new custom node' pop-up window."
      ],
      "align": "center",
      "sizing": "450px",
      "border": true,
      "caption": "Pop-up window for creating a new custom node after selecting the Custom Node option."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/986f86e-1.jpg",
        "custom_node_request_details.png",
        "Screenshot of the custom node request details screen."
      ],
      "align": "center",
      "border": true,
      "caption": " Configuration screen for setting up Request Details in custom node."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c306014-2.jpg",
        "custom_node_configure_authorization.png",
        "Screenshot of the Custom Node Authorization screen."
      ],
      "align": "center",
      "border": true,
      "caption": "Configuration screen for setting up Authorization in custom node."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b31da9b-3.jpg",
        "custom_node_configure_headers.png",
        "Screenshot of configuring headers in the custom node."
      ],
      "align": "center",
      "border": true,
      "caption": "Configuration screen for setting up Headers in custom node."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3861bcc-4.jpg",
        "custom_node_configure_body.png",
        "Screenshot of configuring request body."
      ],
      "align": "center",
      "border": true,
      "caption": "Configuration screen for setting up request Body."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d761040-5.jpg",
        "custom_node_response.png",
        "Screenshot of configuring node events under the Response section."
      ],
      "align": "center",
      "border": true,
      "caption": "Configuring the node events in the Response section."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0d95c83-6.jpg",
        "custom_node_nod_edge.png",
        "Screenshot of configuring the Response Path"
      ],
      "align": "center",
      "border": true,
      "caption": "Configure Response Path"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8a7fc34-7.jpg",
        "custom_node_node_ui.png",
