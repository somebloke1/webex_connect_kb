...
Source: https://help.webexconnect.io/docs/call-patch-node
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:28:55+00:00

The _Call Patch_ node is used to merge the ongoing call with another call. This node exists only within the [Voice Node Group](https://help.webexconnect.io/docs/voice-node-group). Based on your use case you can decide which nodes exist in the node voice group. 



![Call Patch Node](https://files.readme.io/5370070-call-patch-node.png)
...
2. Enter the **Destination (B-PARTY)**. This is the number to which Webex Connect will make the call and it will be a two-party conference.
...
![Call Patch Node Configuration](https://files.readme.io/14a35a8-Call_Patch.jpg)
...
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management-in-flows) are available for use in subsequent nodes. The following are the standard output variables for the _Call Patch_ node:
...
![Output Variables](https://files.readme.io/f6be5a7-Call_Patch1.jpg)
