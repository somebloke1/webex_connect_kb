# Configuring flows with Q&A and Task Bot Nodes - WXCC

Source: https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:28:44+00:00

Webex Connect offers a rich and intuitive Bot Builder to configure QnA bots to automate responses to standard customer queries and configure Task bots to fulfil customer requests without manual intervention. 

Refer [Bot Builder documentation](https://help.imiconnect.io/docs/bot-builder) to know more about how you can configure bots.

The below description covers how you can use bots configured using Webex Connect Bot Builder within the visual flow builder to automate handling of customer requests before escalating it to Webex Contact Centre agents, if needed.
...
![FBM Inbound Message Flow](https://files.readme.io/5c591c0-Picture3.png)
...
![Screenshot of Task bot configuration page.](https://files.readme.io/77ce0d7aa77e65305eccdf3a1ebd71f76ab1fff63ff451d70f157da43aafb86b-image.png)
...
![Screenshot of Transition Actions page.](https://files.readme.io/b1f467f-Messenger.jpg)
...
![Livechat Inbound Message Flow with bot nodes.](https://files.readme.io/a4090db-Picture8.png)
...
![Using Name and Email values collected in pre-chat form and sending them to the bot as Customer Parameters along with balance as Message Parameter](https://files.readme.io/887f1a8d5b81f96c3f8d2f23ffb4a2c12ecb538d2cf4cd17fed48f2524903389-image.png)
