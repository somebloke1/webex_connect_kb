...
This document details the procedure for configuring fulfillment flows for AI Agent actions on <<prodname>> and the steps for selecting these AI Agent-triggered fulfillment flows within the <<WAIStu>>. Execution of an AI Agent action in <<WAIStu>> triggers the corresponding selected flow in <<prodname>>. By default, <<prodname>> automatically notifies flows initiated by AI Agent as the Start node. Upon completion of the flow execution, the system communicates the outcome and any associated payload (defined in the flow outcome settings) back to the AI Agent.
...
1. Click on the preferred **Service** from the Services dashboard.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/cf5e30ab84102c128d890a07f0c193717e139608cf376bf315810aaa92b3e663-AI_1.png","","Select Service"],"align":"center","border":true,"caption":"Select Service "}]}[/block]
2. Click the **Create Flow** button from the Services page.

   [block:image]{"images":[{"image":["https://files.readme.io/b69d1e5f6cf59aa9858f5f2ec1ac8ad8b77943a64ae9533e71a4f025d2cfe178-AI_2.jpeg","","Click Create Flow"],"align":"center","border":true,"caption":"Click Create Flow"}]}[/block]
3. Enter the **Flow Name**. 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/2e2ea2232868c8a0be8e986ca2dbfed10b5655f34e4005d7531c6b02e0e352e7-AI_3.png","","Add Flow Name on Create Flow "],"align":"center","border":true,"caption":"Add Flow Name on Create Flow "}]}[/block]
4. Select **AI Agent** Trigger category as the Start node.

   [block:image]{"images":[{"image":["https://files.readme.io/adb06c8705c05bd591ddfefe6eb7c47c242feeae30aabfaa74fcc6d970117f7d-AI_5.png","","Select AI Agent Trigger Category"],"align":"center","border":true,"caption":"Select AI Agent Trigger Category"}]}[/block]
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/dfd1b7dcbe9be25fc36ba1d9404944ee4b2fd168ab687af3ef4b31faaedb6dbd-AI_Note1.png","","Warning Message received when changed the start node"],"align":"center","border":true,"caption":"Warning Message received when changed the Start Node"}]}[/block]
5. Once you choose AI Agent as the Start node, you will find the event auto-populated as “**Trigger from AI Agent to initiate flow**“.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/2d776f153ce693cddc68984d413097b46a0524b2435218374071b55307cd3acf-AI_7.png","","Configure AI Agent Event"],"align":"center","border":true,"caption":"Configure AI Agent Event"}]}[/block]

   The configuration popup displays an endpoint URL used by <<WAIStu>> to trigger the <<prodname>> fulfillment flow. This URL is secured by Webex CI authentication.  
   A sample input JSON is provided by default in the **Provide sample JSON** which you can modify within the <<WAIStu>>. For more information, refer to [Configure Fulfillment Flows for AI Agent Actions](https://help.webexconnect.io/docs/configure-fulfilment-flows-for-ai-agent-actions#how-to-get-the-payload-on-ai-agent-studio) and click **Parse ** to view the sample payload's parameters as output variables. You can also configure conditional triggering based on the payload. This ensures flows are invoked only when the specified conditions are met.
...
7. The AI Agent is notified of flow completion. By default, the notification for AI Agent is enabled under the flow setting with the default payload. On flow completion, you can update the payload shared with the AI Agent.  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/1b5c7955cac15691355c27e9e4617a45147483349c823d07ff2840b8082b29e2-AI_Note2.png","","Flow Settings"],"align":"center","border":true,"caption":"Flow Settings"}]}[/block]
...
8. Click **Make Live** to publish the flow live. Before going live, make a few settings.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0a93ba8b672fa5021fd2f223dbc699fb79c58860f73bffd98fc50cdba8e103d0-AI_11.png","","Make Live Configuration"],"align":"center","border":true,"caption":"Make Live Configuration"}]}[/block]
9. Click **Make Live**.  
...
## Fulfillment Flow Selection in <<WAIStu>>

**Steps to select a flow in <<WAIStu>>:**

1. Log in to <<WAIStu>> by crosslaunching from Control Hub.

   [block:image]{"images":[{"image":["https://files.readme.io/ef69732c59a11963a57c16b314377fd93c8e245f952bacd4268b18a38c6d3703-AI_Flow-_Intro_1.png","","Webex AI Agent"],"align":"center","border":true,"caption":"Webex AI Agent"}]}[/block]

   [block:image]{"images":[{"image":["https://files.readme.io/33660a510b0fa21231a9aa90382b8311be3b9f25048d18e9f03305fa8a8ee294-AI_Flow_Intro-2.png","","AI Agents"],"align":"center","border":true,"caption":"AI Agents"}]}[/block]
2. Launch the agent. Go to **Actions**. Select the **Action ** for which you want to configure the fulfillment flow. 

   [block:image]{"images":[{"image":["https://files.readme.io/8279a4475d1f2753ddbc9fe530b76be03072a67bd63d385e683c3dbfc5e31617-AI_Flow_1.png","","Actions Tab in AI agent settings "],"align":"center","border":true,"caption":"AI agent settings—Actions Tab"}]}[/block]
3. Scroll down to **Webex Connect Flow Builder Fulfillment**  section on the Actions page.

   [block:image]{"images":[{"image":["https://files.readme.io/f9a2c5a1408473a79733e105d491a51bb5d8b5d96be7032f471f9060cb08cd2a-AI_Flow_2.png","","Webex Connect Flow Builder Fullfillment"],"align":"center","border":true,"caption":"Webex Connect Flow Builder Fulfillment"}]}[/block]
4. **Select a service** that is configured in the <<prodname>> client workspace. This will enable you to view a list of the selected service's flows, where the start node is the AI Agent.
   > 📘 Note
   > 
   > The <<WAIStu>> can only access service and flows configured within the Client-level workspace.
5. **Select a flow** from the dropdown. When the action executes the selected flow in <<prodname>>, the outcomes will be notified to the AI Agent.
...
## Configure the Flow Outcomes for AI Agent in <<prodname>>
...
3. Select **Enter key** and **value** or **Enter JSON ** to use the nested payloads. You can modify the default outcomes as required.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/14c84b56157c255ad28828744675247bbc8f4ebf1d82b50c84f5a4542d89f85e-AI_Flow_Intro-3.png","","Flow Outcomes"],"align":"center","border":true,"caption":"Flow Outcomes"}]}[/block]
...
## How to get the payload on <<WAIStu>>
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ef69732c59a11963a57c16b314377fd93c8e245f952bacd4268b18a38c6d3703-AI_Flow-_Intro_1.png",
        "",
        "Webex AI Agent"
      ],
      "align": "center",
      "border": true,
      "caption": "Webex AI Agent"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/82398ff5215bf47ba0b2c59b48e239d0dac3ade39a00300cfe7ad65149dcd2b4-AI_Flow_Intro-2.png",
        "",
        "AI Agents"
      ],
      "align": "center",
...
2. Launch the agent. Click on **Actions** tab. Select the **Action** for which you want to configure the fulfillment flow.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0aec0c4e8eced35aae66852bf05bb66fa5115160207d11b4cb136f8726fe1ba8-AI_Payload_1.png","","Actions Tab in AI Agent Studio"],"align":"center","border":true,"caption":"Actions Tab in <<WAIStu>>"}]}[/block]
3. Scroll down to **Slot filling** on the **Update Action** page.

   [block:image]{"images":[{"image":["https://files.readme.io/a562538d818aa80b931309b3b710b43b48ab784333277331845511f946021d7b-AI_Payload_3.png","","Slot Filling on the Update Action "],"align":"center","border":true,"caption":"Slot Filling on the Update Action "}]}[/block]
