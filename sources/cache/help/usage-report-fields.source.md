...
| Group Name        | Name of the group on the <<prodname>>  platform                                      |
| TeamName          | Name of the team on the <<prodname>>  platform                                       |
| Service Name      | Name of the service on the <<prodname>>  platform                                    |
...
| messages_submitted      | Number/Count of messages sent using <<prodname>> (Messages submitted to gateways for sending. It’s the multi-part SMS count). |
...
| Service number                                         | Contains the details of the <<prodname>> asset number from which the outbound calls are made or at which the incoming calls are received.                                                                                                                                                                                                                                                                                                  |
...
| messages_sent           | Number of messages sent through MMS channel on the <<prodname>> platform |
...
| Field Name        | Descriptions                                                                     |
| :---------------- | :------------------------------------------------------------------------------- |
| app_id            | Unique id assigned to a channel app asset in <<prodname>>                        |
...
| Field Name        | Descriptions                                                                  |
| :---------------- | :---------------------------------------------------------------------------- |
| app_id            | Unique id of the concerned Facebook Messenger app asset on the <<prodname>>   |
...
| Field Name             | Descriptions                                                              |
| :--------------------- | :------------------------------------------------------------------------ |
| app_id                 | Unique id of the concerned WhatsApp app asset on the <<prodname>>         |
...
| Field Name      | Descriptions                                                      |
| :-------------- | :---------------------------------------------------------------- |
| app_id          | Unique id assigned to application on the <<prodname>>  platform   |
...
| Field Name        | Descriptions                                                                          |
| :---------------- | :------------------------------------------------------------------------------------ |
| app_id            | Unique id of the concerned Apple Messages for Business  app asset on the <<prodname>> |
| active_users      | Number of unique users engaged (by sending or receiving a message)                    |
...
| Field Name        | Descriptions                                                                             |
| :---------------- | :--------------------------------------------------------------------------------------- |
| app_id            | Unique id of the concerned Google Business Messages  app asset on the <<prodname>>       |
| active_users      | Number of unique users engaged (by sending or receiving a message)                       |
| messages_sent     | Number of messages sent through Google Business Messages channel on the platform         |
| messages_received | Number of messages received through Google Messages Business channel on the <<prodname>> |
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "app_id",
    "0-1": "Unique id assigned to application on the <<prodname>> platform",
    "1-0": "carrier_id",
    "1-1": "The unique ID assigned to the carrier of the MSISDN/mobile number to which the message is being sent.",
    "2-0": "carrier_name",
    "2-1": "The name of the carrier of the MSISDN/mobile number to which the message is being sent.",
    "3-0": "country_ISO",
    "3-1": "The name of the country of the MSISDN/mobile number to which the message is being sent.",
    "4-0": "maap",
    "4-1": "Maap of the RCS channel",
    "5-0": "messages_sent",
    "5-1": "Numbers of messages sent through RCS channel on the <<prodname>>",
    "6-0": "basic_received",
    "6-1": "**US:** Incoming text-only messages. Charged per 160-character segment.  \n**Non-US: **Not Applicable.",
    "7-0": "single_received",
    "7-1": "**US: **Incoming media or location (any non-text). Flat rate.  \n**Non-US: **Not Applicable.",
    "8-0": "suggestionclicks_received",
    "8-1": "**US: **Counted when a user taps a suggested reply.  \n**Non-US: ** Not Applicable.",
    "9-0": "messages_received",
    "9-1": "Number of messages received against RCS app on <<prodname>>.",
    "10-0": "messages_delivered",
    "10-1": "Number of messages delivered.",
    "11-0": "capability_requests",
    "11-1": "Number of requests for capability.",
    "12-0": "basic_sent",
    "12-1": "**US:** Text, Suggested Reply, or open URL. Charged per 160-character segment.  \n**Non-US: **Text-only messages 160 characters (UTF-8)",
    "13-0": "single_sent",
    "13-1": "**US: **Rich media (images/video), Carousel, Advanced Actions (WebView, Location). Flat rate.  \n**Non-US: ** Text > 160 characters, messages with any Suggestions, or Rich Media. Flat rate."
  },
  "cols": 2,
  "rows": 14,
  "align": [
...
| Field Name           | Descriptions                                  |
| :------------------- | :-------------------------------------------- |
| Node Name            | Name of the flow on the <<prodname>>platform  |
| Flow Name            | Name of the flow on the <<prodname>> platform |
...
| Field Name               | Descriptions                                                                                                                                                                                                           |
| :----------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| flowname                 | Name of the flow on the <<prodname>> platform                                                                                                                                                                          |
...
| TTS Billables            | <<prodname>> stores the content generated for 24 hours. If the TTS request with same content is made within 24 hours, then it considered as cached content. Characters from such requests are excluded in this column. |
...
| Field Name      | Descriptions                                                        |
| :-------------- | :------------------------------------------------------------------ |
| LogbookID       | Unique id assigned to logbook created on the <<prodname>>  platform |
| Logbook_name    | Name of the logbook created on the <<prodname>> platform            |
...
> 
> The ‘Users’ count available within <<prodname>> Usage section and exported XLS usage reports will exclude Cisco helpdesk users from the calculations.
