<<WebexCC>> users who want to use Live Chat as a channel of customer support with Webex Contact Center can configure a Live Chat asset with <<prodname>> by following the below steps:
...
You can create a Live Chat asset in <<prodname>> (for enabling customer support over Live Chat in combination with Webex Contact Centre) by following the below steps:
...
5. Toggle the Live Chat to enable the configuration section.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/8faf5bb4145436a1154438d2fa72672be9d3d424ab955391bb9d77e2fe62ab85-image.png",null,null],"align":"center","border":true,"caption":"Screenshot of Configuring New Mobile & Web App Page"}]}[/block]
...
8. Select **'Use Secured Port' ** checkbox. This is mandatory for <<prodname>> and <<WebexCC>> integration.
9. Do not select **'Enable payload encryption'** checkbox. This setting is not applicable for <<prodname>> and <<WebexCC>> integration.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2cf2d41-2.jpeg",
        "LC2.jpg",
        "Screenshot of Enabling Use Secured Port in Configuring New Mobile & Web App Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Enabling Use Secured Port in Configuring New Mobile & Web App Page"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ef152f-3.png",
        "Screenshot 2022-12-05 at 7.06.12 PM.png",
        "Screenshot of enabling Server Side Inbox in Configuring New Mobile & Web App Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of enabling Server Side Inbox in Configuring New Mobile & Web App Page."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bf8784b-4.jpg",
        "LC3.jpg",
...
5. Select the required service and click Register (Note: this should be the <<prodname>> service that would be used for configuring Live Chat flows for Webex Contact Center).
6. Click Register.
...
> - Do not delete a Live Chat asset once it's been registered with Webex Engage. Once deleted it cannot be restored. Doing so would lead to asset deletion within <<prodname>> alone while the entry continues to be in Webex Contact Center and Webex Engage.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b903f56-5.jpg",
        "LC5.jpg",
...
As shown above, you will see a <<WebexCC>> icon and a PCI check enabled flag next to the Live Chat asset once it's been successfully mapped with Webex Contact Center.
