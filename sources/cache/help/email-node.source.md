...
<<prodname>> offers the ability to send Emails via two routes. One of the following two routes will be available in your tenant depending on the tenant configuration at the time of onboarding:

- AWS SES for sending and receiving emails.
- SMTP for sending emails and email forwarding for sending a copy of incoming emails to <<prodname>>. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/625b440-Email.jpg",
        "Email.jpg",
        "Screenshot of Email Node"
      ],
      "align": "center",
      "caption": "Email Node"
    }
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a8bc12a-Email_Node.jpg",
        "",
        "Screenshot of Configuring an Email"
      ],
      "align": "center",
      "border": true,
      "caption": "Configuring an Email "
    }
  ]
}
[/block]
...
For sending an Email, <<prodname>> supports the below two destination types:
...
Allows you to pass the link to your own subscription management portal, as part of the list-unsubscribe headers, instead of using <<prodname>> subscription management capability.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/45631a6-Email_Node.jpg",
        "",
        "Screenshot of Fallback Text for Email"
      ],
      "align": "center",
      "border": true,
      "caption": "Fallback Text for Email"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d4208dc-email_html_1.png",
        null,
        "Screenshot of Link Tracking"
      ],
      "align": "center",
      "border": true,
      "caption": "Link Tracking"
    }
  ]
}
[/block]
...
<<prodname>>recommends uploading the required attachments to Media Manager and use that URL in the attachments section. The URL is valid and complete only when it ends with the file extension.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1374d4a-email_add_attachment.jpg",
        null,
        "Screenshot of Add Attachments."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Add Attachments"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/78d853b-email_add_attachment.jpg",
        null,
        "Screenshot of Add Attachments."
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d37dc56-image.png",
        null,
        "Screenshot of Adding Dynamic Attachments Payload."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Adding Dynamic Attachments Payload."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3b481fa-4ec4c492-8108-42a0-814b-29632172c98b.png",
        "4ec4c492-8108-42a0-814b-29632172c98b.png",
        "Screenshot of SMTP Headers."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of SMTP Headers."
    }
  ]
}
[/block]
