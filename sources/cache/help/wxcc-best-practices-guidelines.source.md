...
**Enable Attachment Support within <<WebexCC>>**

- Please ensure that you have enabled the ability to receive attachments within <<WebexCC>>.
...
For the <<prodname>> and <<WebexCC>> integration flows, we recommend you to use the Client level services, and not configure assets or flows for these integrations at a Group or Team level.

**Configuring authorizations for <<WebexCC>> integration nodes**
...
**<<prodname>> Services used for Webex Contact Center Flows**
...
It is recommended that you modularise your flows using Call Workflow node if you have a large flow and are observing delays in flow loading during flow configuration/design. Refer to [Call Workflow Node](https://help.imiconnect.io/docs/call-workflow) for more info on when this issue may be observed typically.