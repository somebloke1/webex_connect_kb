The Reports section helps you view and analyze your messaging and flow traffic across various services. <<prodname>> provides reporting at three levels - platform level summary, channel asset level summary, and service level summary. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/36c51f5-10.jpg",
        "Reports Platform Summary.png",
        "Screenshot of Reports Page."
      ],
      "align": "center",
      "sizing": "smart",
      "border": true,
      "caption": "Screenshot of Reports Page."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/25245b3-24.jpg",
        "Platform Summary Report.png",
        "Screenshot showing the selection of the Summary option under the Entity dropdown menu on the Platform."
      ],
      "align": "center",
      "sizing": "smart",
      "border": true,
      "caption": "Navigating to the Summary option in the Entity dropdown menu on the Platform with specified time period"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/125b7fc650720b86a147a5c14c017968bcecf929b53bbfd21be754e806078915-image.png",
        null,
        "Custom Date pop-up appears when you choose custom time period. This allows to generate a report with a specified date/time range."
      ],
      "align": "center",
      "sizing": "80% ",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d9824aa-13.png",
        "",
        "Screenshot of Service Level Report for WhatsApp Channel."
      ],
      "align": "center",
      "border": true,
      "caption": "Service Level Report for WhatsApp Channel."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f294396-14.jpg",
        "Download Reports Data.png",
        "Screenshot displaying to download the reports."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying to download the reports."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/83da0899d028210127432decab12eb85c66ae8f62daf26d874cc1c1a9bcec3d7-ob_email_dr.png",
        null,
        "Screenshot of Sample report for Email channel usage at a service level."
      ],
      "align": "center",
      "border": true,
      "caption": "Sample report for Email channel usage at a service level."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c318258eb11678a7173cea196ca0976245182cc28bcabcf34868967d287a9b0f-Bounce1.jpg",
        null,
        "Screenshot of Messages Bounced and Email Complaints"
      ],
      "align": "center",
      "border": true,
      "caption": "Messages Bounced and Email Complaints"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2051f11e6bfae283061699090715efa4f007e714e9aa5344271b8b33eb26df30-2025-07-25_10-49-03.png",
        "",
        "Sample Report for Voice Channel usage at service level"
      ],
      "align": "center",
      "border": true,
      "caption": "Sample Report for Voice Channel usage at service level"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/182857aaa4aa06955ccb4b40838f4980a76a62ec68281b85fed367f4183b5d5f-image-20250225-152232.png",
        null,
        "Screenshot of SMPP Reports"
      ],
      "align": "center",
      "border": true,
      "caption": "SMS Reports"
...
- Total Requests  - Number of requests submitted by the user to the <<prodname>> platform.
- Requests Submitted - Number of requests submitted by the <<prodname>> platform to the messaging gateways.
- Requests Scheduled - Number of requests waiting to be submitted by the <<prodname>> platform to the messaging gateways.
- Requests Rejected - Number of requests rejected by the <<prodname>> platform.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9b2d0a6-10.png",
        null,
        "Asset Level Report for SMS Channel."
      ],
      "align": "center",
      "border": true,
      "caption": "Asset Level Report for SMS Channel."
    }
  ]
}
[/block]
...
Alternatively, the reports can be viewed at a channel asset level by selecting the channel asset for example a Number (in case of SMS and Voice), or an App (for OTT channels such as <<AMB>> and WhatsApp). 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aa8c85c-3.jpg",
        "Channel Assest Level Summary.png",
        "Asset Level Report for SMS or Voice Channel."
      ],
      "align": "center",
      "sizing": "450px",
      "border": true,
      "caption": "Asset Level Report for SMS or Voice Channel."
    }
  ]
}
[/block]
...
The details of messages received on the selected channel asset (i.e. a number or an app) will be available as shown below. This is the aggregated count of messages received on the select asset across various services within <<prodname>> where the selected asset is being used. Hover over the line graph to get the details of the number of messages received on any given day within the selected time period.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9cda302-4.jpeg",
        "Channel Assest Level - Messages Received.png",
        "Asset Level Report for SMS or Voice Channel."
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bccb285-6.jpg",
        "",
        "Screenshot of the Service Specific Dashboard"
      ],
      "align": "center",
      "border": true,
      "caption": "Service Specific Dashboard"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/62aeb339a95cd230122b88ab56fc2f9bdbbc82ef5962f4c5fa38bf5961fefae0-image-20250225-090556.png",
        "Services Level Report for SMS Channel.png",
        "Screenshot of the Service Level Report for SMS Channel"
      ],
      "align": "center",
      "border": true,
      "caption": "Service Level Report for SMS Channel."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5ef7681ce7d07b4e6ad17f9f14ff844229f87281151ccbc32b5b62a310fe55ab-Reports.jpg",
        "Services Level Report for a Flow.png",
        "Screenshot of the Sample Report for a Flow within a Service"
      ],
      "align": "center",
      "border": true,
      "caption": "Sample Report for a Flow within a Service"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2ce6b2c-sankey_view_reports.png",
        "sankey_view_reports.png",
        "Screenshot of the Sample Sankey Chart Report"
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3ec4fd9553f971e8f52f7e92ab8f71a81dc83d5724dd78fd0171dae023ac475d-webex-connect-reports-link-shortener.png",
        null,
        "Reports page showing Link Shortener selected as the entity, with Link Shortener engagement metrics for creates, clicks, and click-through rate."
      ],
      "align": "center",
      "border": true,
      "caption": "Sample report for Link Shortener engagement."
    }
  ]
}
[/block]
