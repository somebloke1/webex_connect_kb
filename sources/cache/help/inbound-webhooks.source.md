Inbound Webhooks generate a unique endpoint that can be embedded into your applications to notify <<prodname>> of events occurring on business systems.
...
> a. Service Key based
> 
> b. JWT based authentication. When authentication is enabled you need to use one of service key or JWT credentials associated with the relevant <<prodname>> service which contains the rule/flow you've associated the inbound webhook with.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bdc8fba23a7b2007ec2008277bca8190472035f0af9c782440624de71d313b76-05_31_19.jpg",
        "",
        "Screenshot for Inbound Webhook with a trigger condition to invoke the flow"
      ],
      "align": "center",
      "border": true,
      "caption": "Inbound Webhook with a trigger condition to invoke the flow"
    }
  ]
}
[/block]
