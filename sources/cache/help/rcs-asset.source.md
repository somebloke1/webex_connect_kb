...
1. To configure the RCS app, sign in to the <<prodname>> platform, go to **Assets** > **Apps **.  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8423d11-RCS.png",
        "Assets RCS Configure RCS application to imiconnect.png",
        "Screenshot of Selecting the Apps from Assets Menu."
      ],
      "align": "center",
      "border": true,
      "caption": "Selecting the Apps from Assets Menu."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8a6837e-RCS1.jpg",
        "Assets RCS RCS App Addition.png",
        "Screenshot of Configuring New RCS Application."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configuring New RCS Application."
    }
  ]
}
[/block]
...
In a flow, you can configure the [Receive](https://help.imiconnect.io/docs/receive) node to receive messages from RCS users and the [RCS Message Node](doc:rcs-message-node) node enables you to deliver messages to the RCS user.
