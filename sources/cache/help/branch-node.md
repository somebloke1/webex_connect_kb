...
Source: https://help.webexconnect.io/docs/branch-node
...
![Branch Node](https://files.readme.io/9bc1aa1-branch_icon.png)
...
![Branch Node Configuration](https://files.readme.io/0f0f3aa-Branch_Node_Branch_Node_Configuration.png)
...
![Branch Conditions](https://files.readme.io/a374803-branchnode_new_operators1.png)
...
![Output Variables](https://files.readme.io/3a7f5e5-output_variables.png)
...
| --- | --- |
| Success (green)<br>  <br>  <br>**Note**: You can see this node edge only when you complete the node configuration. | \* **Branch1** - the flow exits through this node when it is a success. This node is replaced by the branch name for every branch that you configure. For example, if you configure a branch as Request Detailed feedback, the **Branch1** node is replaced by <code>Request Detailed Feedback</code> and likewise for all other branches. For illustration, see the [configuration window](https://files.readme.io/16d9446-branch_node.png). |
...
![Node Outcomes](https://files.readme.io/d4c20a6-node_outcomes.png)
...
![Define Transition Actions](https://files.readme.io/3d8d241-transition_actions.png)
...
![Configure the branch to capture user rating](https://files.readme.io/6918c9d-branch1.png)
...
![Configure the branch to capture user rating](https://files.readme.io/3eb7bd9-branch2.png)
...
![Test the Node Configuration](https://files.readme.io/6469a03-test_node.png)
