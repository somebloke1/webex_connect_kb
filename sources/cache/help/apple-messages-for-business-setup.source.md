...
4. Enable **Payment** toggle and provide the following details that you have obtained here: _Merchant ID_, _Merchant Name_, _Domain Name_  as shown below.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/92b7074-2024-06-06_16h06_55.png","","Screenshot of Enable Payment"],"align":"center","caption":"Enable Payment"}]}[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Screenshot of Apple Business Register."
      ],
      "align": "center",
      "sizing": "smart",
      "border": true,
  ...
  "images": [
    {
      "image": [
        ...
        "manage_app_ABP.png",
        "Screenshot displaying Enable Authentication."
      ],
      "align": "center",
      "sizing": "smart",
      "border": true,
...
Once your authentication configuration is setup on both Apple Business Register and <<prodname>>, you can start using it in a flow. For more information, refer to [Configuring a New Authentication](https://help.imiconnect.io/docs/apple-messages-for-business#configuring-a-new-authentication).
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Screenshot displaying the Add Preview For Domain Button."
      ],
      "align": "center",
      "border": true,
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Screenshot diaplying the enter the Domain Name"
      ],
      "align": "center",
      "border": true,
      "caption": "Domain Name"
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Screenshot displaying to Choose File to upload the image"
      ],
      "align": "center",
      "border": true,
