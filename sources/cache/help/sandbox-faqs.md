...
Source: https://help.webexconnect.io/docs/sandbox-faqs
...
Please refer to [a list of countries](https://developers.imiconnect.io/reference/sms-and-voice-support-in-sandbox) you can use Webex Connect Sandbox for sending or receiving test SMS messages and voice calls.
...
Here's a brief list of features that are not available in Webex Connect sandbox mode and require you to upgrade to Webex Connect full platform mode:

- Additional channels such as Email, Push & In-App Messaging, Apple Messages for Business, Facebook Messenger, RCS, and more.
...
- Ability to invite your colleagues to work collaboratively in the same Webex Connect account 
...
Yes, Webex Connect Sandbox mode provides you access to a limited number of nodes that are sufficient for prototyping automated 2-way interactions/journeys across SMS, voice, and WhatsApp. The list of nodes that are available as part of Webex Connect sandbox includes:
...
## Does Webex Connect sandbox provide an API for bulk SMS sending?

No, Webex Connect sandbox mode does not offer an API for bulk SMS messaging.
...
## Which all countries can I send and/or receive SMS and Voice calls from using Webex Connect sandbox?
...
You can register one primary and four secondary numbers with each Webex Connect sandbox account. You cannot change the primary number (i.e., the first number that you register with Webex Connect) but can change the secondary numbers registered with an Webex Connect account. 
...
## Can I setup chatbots using Webex Connect sandbox account?

Currently, Webex Connect Bot Builder and NLP/NLU nodes are available only in the full platform mode once you have subscribed for it. You can use Webex Connect Sandbox for configuring basic chatbots through keyword matching or by integrating Webex Connect flows with other bot platforms.
...
![Verify phone number & Create account](https://files.readme.io/50b4cddb14f8cc359f9de015301698c6cc5d14ce071b6055ced66ab8fb9cfd58-image.png)
