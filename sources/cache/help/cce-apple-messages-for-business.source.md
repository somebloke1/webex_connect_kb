<<CCE>> users who want to use <<AMB>> as a channel of customer support with Webex Contact Center can easily register their Messages for Business account on <<prodname>> by following the procedures on this page.
...
4. Enable **Payment** toggle and provide the following details that you have obtained here: _Merchant ID_, _Merchant Name_, _Domain Name_  as shown below
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/cac4c2c-image.png",null,"Enable Payment"],"align":"center","caption":"Enable Payment"}]}[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "",
        "Choose File to upload the image"
      ],
      "align": "center",
      "border": true,
...
3. Select the required <<AMB>> channel for which you want to register with Webex Engage.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0dce53c-11.png",null,"Apple Messages for Business"],"align":"center","border":true,"caption":"Apple Messages for Business"}]}[/block]

4. In **Manage App - Apple Messages for Business** page, click **Register to Webex Engage**.

   [block:image]{"images":[{"image":["https://files.readme.io/53ab16d-Manage_App_AMB.png",null,"Register to Webex Engage"],"align":"center","caption":"Register to Webex Engage"}]}[/block]
...
5. Select the required service (this should be the <<prodname>> service that would be used for configuring Apple Messages for Business flows for <<CCE>> and click **Register**.  
   The message "Asset registered successfully" is displayed.

As shown above, you will see a Webex Engage icon and a PCI check-enabled flag next to the App name once it's been successfully mapped with <<CCE>>.
