...
This setting determines the time zone setting for your <<prodname>> tenant. Once configured and/or updated it applies to all the users of the concerned <<prodname>> tenant. When the time zone is updated here, it affects the following:
...
> 📘 Note
> 
> <<prodname>> platform doesn’t support changing/applying the time zone setting only for reports, both at tenant level and user level.

Based on your selection, your account time is displayed on the UI of the platform wherever time has to be selected and the selection a user makes is in the time zone selected for the respective <<prodname>> tenant account. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/01511f5-Tenant_Settings.jpg",
        "Tenant Settings.jpg",
        "Image showing the interface for configuring Tenant Level Time Zone Settings"
      ],
      "align": "center",
      "border": true,
      "caption": "Tenant Level Time Zone Settings"
    }
  ]
}
[/block]
...
<<prodname>> supports daylight saving by enabling you to send notifications on the time they were scheduled for, irrespective of the time difference. The events can be scheduled for daylight savings. If applicable to your time zone, the daylight savings are automatically taken into account. <br>
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/94559c7-Administration_Tenant_Settings_Profile_Key.png",
        "Administration Tenant Settings Profile Key.png",
        "Image showing the interface section where the Profile Key is displayed."
      ],
      "align": "center",
      "caption": "Profile Key"
    }
...
The **Allow <<prodname>> Help Desk Team to access my/this <<prodname>> (Read Only)** option enables you to assign read-only access to the help desk users to cross-launch into the tenant application for providing support. This option is enabled by default.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/571ba41c06b1682d7c1e9ff7041adfe5b06111b009e5c5f43c16191263918897-Helpdesk.png",
        "",
        "Image showing the interface of the Help Desk section"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the Help Desk section"
    }
  ]
}
[/block]
...
If it is disabled for your tenant, select **Allow <<prodname>> Help Desk Team to access my/this <<prodname>> Tenant (Read Only)** to enable this function.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7b68936-2.jpeg",
        "",
        "Image showing the interface of the Account Details."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the Account Details"
    }
  ]
}
[/block]
...
Partners can use the <<prodname>> quick links to directly cross-launch the <<prodname>> platform for a Contact Center Business Unit (CCBU) customer from the Control Hub. The <<prodname>> link  is visible under Contact Center Suite, only if digital channels are enabled and the tenant provisioning is completed in the Control Hub. The following image illustrates where the quick links are visible.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ed77ed6-Screenshot_2024-02-22_at_7.16.00_PM.jpg",
        "",
        "Image showing the interface with the option for Partner and Tenant User Cross Launch"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the option for Partner and Tenant User Cross Launch"
    }
  ]
}
[/block]
...
A tenant owner created as part of tenant provisioning will also be able to cross-launch directly into the <<prodname>> platform from Control Hub.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/19766a2-Helpdesk.png",
        "",
        "Screenshot of Tenant Settings Page"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Tenant Settings Page"
    }
  ]
}
[/block]
...
3. Under **IP Address Allowlist**, enter a valid IPv4 address or CIDR range in the **IP address or CIDR range** field.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/a029325432479ae5fc79f1afeecabc80b3fcbaf18a41977abcf82579f549a921-Screenshot_2026-07-27_at_15.08.39.png","","Screenshot of IP Address Allowlist section in Tenant Settings"],"align":"center","border":true,"caption":"Screenshot of IP Address Allowlist section in Tenant Settings"}]}[/block]
...
Manage your <<prodname>> account settings for your organization. Only account owners can make changes to tenant settings.
...
When you use <<prodname>> for managing customer interactions over messaging channels such as Apple Messages for Business, WhatsApp, Facebook Messenger, etc., by default the incoming attachments and media files from customers a persistent publicly accessible URL is generated by the channel provider (such as in case of Facebook Messenger) or by <<prodname>> (for WhatsApp RCS and In-App Messages/Live Chat). 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/36b1b03-Inbound1.jpg",
        "Inbound1.jpg",
        "Image showing the interface for configuring Inbound Media Handling on Messaging Channels"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the Inbound Media Handling on Messaging Channels"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7b2f5f3-Inbound.jpg",
        "Inbound.jpg",
        "Image showing the interface for configuring the Expiry Time"
      ],
      "align": "center",
      "border": true,
      "caption": "Image showing the interface for configuring the Expiry Time"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1ab2c6b100c109928490ba043e1f1f6cbdb369a9e6f389c5514e07de9234da04-Bounce.png",
        "",
        "Image showing settings for the Bounce List Retention Period for emails sent through AWS SES."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the Bounce List Retention Period for Email via AWS SES"
    }
  ]
}
[/block]
