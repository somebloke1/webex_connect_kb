...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ef075e9-Branch.jpg",
        "IMIconnect-branch-node-flow.png",
        "Screenshot of the branch node configuration in flow builder."
      ],
      "align": "center",
      "border": true,
      "caption": "Setting up a branch node with conditions in a flow builder."
    }
  ]
}
[/block]
