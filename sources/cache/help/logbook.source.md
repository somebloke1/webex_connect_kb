...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/860e0c2-Configure_Logbooks.jpg",
        "Basic Details.png",
        "Screenshot displaying the basic details of the logbook"
      ],
      "align": "center",
      "border": true,
      "caption": "Basic Details of the logbook"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3a3bae5-Logbooks-_Custom_attributes.jpg",
        "Custom Attributes.png",
        "Screenshot displaying the list of Custom Attributes"
      ],
      "align": "center",
      "sizing": "400px",
      "border": true,
      "caption": "Screenshot displaying the list of Custom Attributes"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a006ab5-Logbooks-_file_settings.jpg",
        "File_Settings.png",
        "Screenshot displaying the File Settings"
      ],
      "align": "center",
      "sizing": "500px",
      "border": true,
      "caption": "Screenshot displaying the File Settings"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "FILE TYPE",
    "0-1": "Select the logbook file type to save the data. You can save the logbook in .CSV or .TXT format.",
    "1-0": "FILE NAME PREFIX",
    "1-1": "This prefix is added to the logbook files when files are generated.  \n  \nE.g: APILOGBOOK20181219123906747.txt"
  },
  "cols": 2,
  "rows": 2,
  "align": [
...
[block:parameters]
{
  "data": {
    "h-0": "Parameter",
    "h-1": "Description",
    "0-0": "Tab, Semicolon, Comma, Space,  Others",
    "0-1": "Select one of the delimiters types to place between data (separator).",
    "1-0": "Include attributes as column header in the file",
    "1-1": "Check this option of include the customer attribute as headers of the data being captured in the logbook.",
    "2-0": "Add end of file",
    "2-1": "Check this option and enter the content or variable to be placed at the end of the file.  \n  \nE.g: Total: $(count_of_records) or End of Records.",
    "3-0": "Password protect the file",
    "3-1": "Check this option to create password-protected logbooks. You are required to enter a  password in the textbox provided.  \n  \nHereafter, log files will be zipped and password protected with the passcode provided."
  },
  "cols": 2,
  "rows": 4,
  "align": [
...
> 📘 Note
> 
> - Local storage option stores the data at <<prodname>>'s end. The standard retention policy for local storage is 30 days. 
> - The use of 'Local' as a file destination for logbooks is no longer supported and is deprecated for new logbook configurations. Existing logbooks that are already configured with 'Local' as file destinations will continue to be supported until updated, but we recommend switching to S3 or SFTP.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d1a648a-Logbooks-_Rotation1.jpg",
        "2021-07-14_16-44-52.jpg",
        "Screenshot of Configuring New Logbook"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configuring New Logbook"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Description",
    "0-0": "Destination",
    "0-1": "The destination to store the log file once the logbook is generated. You can set the destination to 'SFTP or  AWS S3'.  \n  \nYou can upload the private key (example: AWS based Open SSH key files like rsa512.ppk, rsa256.ppk, ecdsa521.ppk, ecdsa384.ppk, ecdsa256.ppk, ed25519.ppk, ECDSAprivate.ppk, EDDSA255private.ppk) for SFTP configuration, when you select the File Destination as SFTP using the **Upload** button.",
    "1-0": "FILE ROTATION NOTIFY URL",
    "1-1": "A notification is sent at the defined URL when a new log fine is generated. If an invalid URL is passed in API request or via a variable, then such request will not be considered eligible for retries.",
    "2-0": "Notify on Email",
    "2-1": "A notification is sent at the provided email address when a new log file is generated."
  },
  "cols": 2,
  "rows": 3,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/10cf755-Logbooks_-_Lock.jpg",
        "logbook_locking.png",
        "Screenshot displaying the list of Logbooks"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot displaying the list of Logbooks"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1d92760-Logbooks_-_Lock1.jpg",
        "logbook_locking1.png",
        "Screenshot of configuring the New Logbook"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Configuring the New Logbook"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aa88eaf-Flow_Settings3.jpg",
        "logbook.png",
        "Screenshot of Mapping the Logbook to Flow."
      ],
      "align": "center",
      "caption": "Screenshot of Mapping Logbook to Flow"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7d45368-Edit_Teammates.jpg",
        "2021-07-14_21-20-54.jpg",
        "Interface showing steps to edit roles for users, enabling or restricting access to Logbooks"
      ],
      "align": "center",
      "sizing": "400px",
      "border": true,
      "caption": "Screenshot displaying how to edit user roles for access to Logbooks"
    }
  ]
}
[/block]
