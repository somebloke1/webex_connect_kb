...
Source: https://help.webexconnect.io/docs/flow-analytics
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:28:42+00:00

The _Analyse_ mode of Webex Connect Flow Builder provides you the ability to analyze the performance of your published flows at every node. The _Analyse_ mode provides an aggregate view of the execution counters at every node, enabling you to analyze the flow traffic and make necessary changes as per the customer interaction patterns. The data is refreshed every 15 minutes.
...
![Switch Modes](https://files.readme.io/c572967-build_analyse_modes.png)
...
![Counters on Nodes and Connectors](https://files.readme.io/bbedba1-node_connector_counters.png)
...
![Average Flow Execution Time](https://files.readme.io/60f8c78-avg-execution-time-duration-metrics.png)
...
![Date and Time Range Selector](https://files.readme.io/9f9737f-time_range_selector.PNG)
...
![Select Version](https://files.readme.io/6385331-flow-execs-version-dropdown.png)
...
![Search in Sankey Chart](https://files.readme.io/9747383-search-sankey.png)
...
![Node and Connector Labels Off](https://files.readme.io/4284ca8-labels_off.PNG)
...
![Share Flow Settings](https://files.readme.io/793c167-share_flow.png)
...
![Node Selection](https://files.readme.io/b6a3b6a-selected_nodes.PNG)
...
![Saved Charts](https://files.readme.io/76ae2e0-savedcharts_list.PNG)
...
![View Chart Button.](https://files.readme.io/adb739c-view_chart_button.PNG)
...
![Sankey Chart](https://files.readme.io/4997614-sankey_chart.PNG)
...
![Screenshot of Export Options for Sankey Chart](https://files.readme.io/6c46107-sankey_export_options.png)
...
When you navigate through the workflow reports for a specific workflow, you can see the report in the form of a Sankey chart. See the [Reports](https://help.webexconnect.io/docs/service-reports#section-sankey-view) section for more details.
...
![A Sample Sankey Chart Report](https://files.readme.io/153fba4-sankey_view_reports.png)
