<<prodname>> stores the customer data on the same cloud as that of the platform. The platform supports two-way syncing of customer data to a remote site. The process of synchronization is set up on a case-by-case basis. Some of the common requests supported on <<prodname>> include:

  * Setting up FTP / SFTP for scheduled file processing for ingesting data into <<prodname>>
