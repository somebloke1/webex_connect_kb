...
<<prodname>> offers a pre-built integration node for Agile CRM to make it easier for you to create, view, delete, and/or update tickets and contacts in your Agile CRM account. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/957bad6-image.png",
        null,
        "Screenshot of Agile CRMs Node."
      ],
      "align": "center",
      "caption": "Screenshot of Agile CRMs Node"
    }
  ]
}
[/block]
...
- Agile CRM node needs to be enabled for your <<prodname>> tenant and is not available by default. Please contact your account manager in case you wish to enable it for your account.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/de884eb-Agileconfig.jpg",
        "Agileconfig.jpg",
        "Screenshot of Agile CRM Configuration Page."
      ],
      "align": "center",
      "caption": "Screenshot of Agile CRM Configuration Page"
    }
  ]
}
[/block]
...
5. You can see the data that this node generates under the Output Variables section. These [variables](doc:variable-management) are available for use in subsequent nodes. (Ref: right panel in the below image).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ad6cf1-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/76c3a90-image.png",
        null,
        "Screenshot of Create a ticket method configuration page."
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2abce7f-image.png",
        null,
        "Screenshot of Get all tickets method configuration page"
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Get all tickets method configuration page."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bb7ee9d-image.png",
        null,
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "<p>Node Outcomes</p>",
    "h-3": "<p>Version</p>",
    "0-0": "<p><strong>Ticket ID</strong> </p><ul><li>Specifies the unique identification number of the ticket</li></ul>",
    "0-1": "<p><strong>status</strong> </p><ul><li>Contains the status for the ticket</li></ul>",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a80dc5e-image.png",
        null,
        "Screenshot of Creating a contact method configuration page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Creating a contact method configuration page."
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "<p>Node Outcomes</p>",
    "h-3": "<p>Version</p>",
    "0-0": "<p>Start Value<br>Lead Score<br>Tags</p><p><strong>First Name</strong></p><ul><li>Specifies the customer’s First Name</li></ul><p><strong>Last Name</strong></p><ul><li>Specifies the customer’s last name</li></ul><p><strong>Email</strong></p><ul><li>Specifies the email address of the user</li></ul><p><strong>Address</strong></p><ul><li>Specifies the address of the user</li></ul><p><strong>City</strong></p><ul><li>Specifies the city of the user</li></ul><p><strong>State</strong></p><ul><li>Specifies the name of state in which the user currently in</li></ul><p><strong>Zip Code<br></strong>  \\* Specifies the zip code of the user</p><p><strong>Country</strong> </p><ul><li>Specifies the name of country in which the user currently in</li></ul>",
    "0-1": "<p><strong>id</strong></p><ul><li>Contains the unique identification number of the contact</li></ul><p>type</p><p><strong>created_time</strong></p><ul><li>Contains the time on which the record is created. This is in the UTC format</li></ul><p><strong>responsePayload</strong> </p><ul><li>Contains all the response JSON payload</li></ul>",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a32d80a-Get_Contact_by_ID.jpg",
        "Get Contact by ID.jpg",
        "Screenshot of Get contact by ID method configuration page."
      ],
      "align": "center",
      "caption": "Screenshot of Get contact by ID method configuration page."
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "<p>Node Outcomes</p>",
    "h-3": "<p>Version</p>",
    "0-0": "<p><strong>Contact ID</strong> </p><ul><li>Specifies the unique identification number of the contact</li></ul>",
    "0-1": "<p><strong>id</strong></p><ul><li>Contains the unique identification number of the contact</li></ul><p>type</p><p><strong>created_time</strong></p><ul><li>Contains the time on which the record is created. This is in the UTC format</li></ul><p><strong>updated_time</strong></p><ul><li>Contains the time on which the record is updated. This is in the UTC format</li></ul><p>star_value<br>lead_score<br>contact_company_id</p><p><strong>owner_id</strong></p><ul><li>Contains the unique identification number of the owner</li></ul><p><strong>owner_email</strong></p><ul><li>Contains the email address  of the owner</li></ul><p><strong>owner_phone</strong></p><ul><li>Contains the phone number of the owner</li></ul><p><strong>owner_name</strong></p><ul><li>Contains the name of the owner</li></ul><p><strong>responsePayload</strong> </p><ul><li>Contains all the response JSON payload</li></ul>",
    "0-2": "onGetContactByIDSuccess  \nonGetContactByIDFailure",
    "0-3": ""
  },
  "cols": 4,
  "rows": 1,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/59f8b95-image.png",
        null,
        "Screenshot of Update Properties of a Contact by ID method configuration page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Update Properties of a Contact by ID method configuration page."
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "<p>Node Outcomes</p>",
    "h-3": "<p>Version</p>",
    "0-0": "<p>ID</p><p>First Name</p>",
    "0-1": "<p><strong>id</strong></p><ul><li>Contains the unique identification number of the contact</li></ul><p><strong>created_time</strong></p><ul><li>Contains the time on which the record is created. This is in the UTC format</li></ul><p><strong>updated_time</strong></p><ul><li>Contains the time on which the record is updated. This is in the UTC format<br>entity_type</li></ul><p><strong>responsePayload</strong> </p><ul><li>Contains all the response JSON payload</li></ul>",
    "0-2": "onUpdatePropertiesOfContactByIDSuccess  \nonUpdatePropertiesOfContactByIDFailure",
    "0-3": ""
  },
  "cols": 4,
  "rows": 1,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e148569-Delete_Single_Contact.jpg",
        "Delete Single Contact.jpg",
        "Screenshot of Delete Single Contact method configuration page."
      ],
      "align": "center",
      "caption": "Screenshot of Delete Single Contact method configuration page."
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "<p><strong>Contact ID</strong> </p><ul><li>Specifies the unique identification number of the contact</li></ul>",
    "0-1": "none",
    "0-2": "onDeleteSingleContactSuccess  \nonDeleteSingleContactFailure",
    "0-3": ""
  },
  "cols": 4,
  "rows": 1,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c4ce423-Get_all_Filter_IDs.jpg",
        "Get all Filter IDs.jpg",
        "Screenshot of Get all Filter IDs method configuration page."
      ],
      "align": "center",
      "caption": "Screenshot of Get all Filter IDs method configuration page."
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-3": "<p>Version</p>",
    "0-0": "",
    "0-1": "<p><strong>responsePayload</strong> </p><ul><li>Contains all the response JSON payload</li></ul>",
    "0-2": "onGetAllFilterIDsSuccess  \nonGetAllFilterIDsError",
    "0-3": ""
  },
  "cols": 4,
  "rows": 1,
