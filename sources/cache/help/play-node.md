...
Source: https://help.webexconnect.io/docs/play-node
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:28:55+00:00

The _Play_ node is used to play audio or voice prompts to the customers at the beginning of a call or during the call. The _Play_ node can be used only within the [Voice Node Group](https://help.webexconnect.io/docs/voice-node-group). 



![Play Node](https://files.readme.io/3e1348d-play.png)
...
![Screenshot of Play Node Configuration Page.](https://files.readme.io/2a98718-Play1.jpg)
...
![Uploading a file](https://files.readme.io/5405c6b-Play2.jpg)
...
<br />
   ...
   (iii) **URL** - Enter the URL that contains the audio file. Optionally, you can click Fetch to listen to the prompt during configuration when you using a static URL configuration. The voice file URL can be passed dynamically using a variable as well. Note that Webex Connect  supports only HTTP URLs at the moment.
...
![Fetching a URL](https://files.readme.io/4eb38a5-Play3.jpg)
...
![Text To Speech](https://files.readme.io/127e49d-Play4.jpg)
...
2. **SSML** - If you want to control the text-to-speech output using Speech Synthesis Markup Language, you can select SSML option. SSML is an XML-based markup language that lets you specify how input text is converted into synthesized speech using the text-to-speech service.  
   Webex Connect offers SSML option in the Play node allowing you to control the text-to-speech  
...
> 
> Webex Connect offers the option to submit text-to-speech synthesis requests using SSML tags within ‘Play’, ‘IVR Menu’, ‘Record’, ‘Collect Input’, and ‘Call Patch’ nodes as well.
