<<prodname>> supports sending and receiving messages in all international language characters. In fact, through <<prodname>>, you can send or receive messages that contain any character specified in UTF-8 encoding standard, across all available channels.  
