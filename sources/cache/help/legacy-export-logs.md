...
Source: https://help.webexconnect.io/docs/legacy-export-logs
...
![Screenshot of Export Logs](https://files.readme.io/bc2b1ed-Export_Logs_Default.jpeg)
...
| --- | --- | --- |
| SMS | Segments [Segment counts for outbound SMS transactions for which delivery receipts have not been received by the time of exporting the logs will be logged as zero (value ‘0’)]. | Segments |
...
| Apple Business Chat | ABC ID  <br>Payload | Date  <br>ABC ID |
