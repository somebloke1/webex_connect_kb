...
Source: https://help.webexconnect.io/docs/local-storage-wxcc
...
WhatsApp Cloud API provides such an extra layer of data protection by implementing additional data management controls. The local storage feature comprises two additional constraints in the Cloud API runtime environment:
...
Steps to update local storage of an existing asset:
...
![Number not verified](https://files.readme.io/3eb59d69bcf3050616e084f56e3246942eddab32c0f37f7d35545d5484075de3-image.png)
...
4. Click **Save**.
   > 📘 Note
   > 
   > Downtime for the localization update is less then 5 minutes.



![Localization using Embedded Sign-up ](https://files.readme.io/1e88ec2f28d0d552fbddf6fe12ebe56c841aaa2796aa9cb519a75f1aaf3b714a-image.png)
...
![Localization using Manual Sign-up](https://files.readme.io/c816b35022aca598ff029352ba23c7bc94dffc07d2a67a9eb65c9140602cb417-image.png)
