# WhatsApp Usernames and Business-Scoped User IDs (BSUID) - WXCC

Source: https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-wxcc
