...
Source: https://help.webexconnect.io/docs/social-hour-check-node
...
- **Wait for next available social hours **- In this case, Webex Connect waits at this node until the next social hour window opens (based on your configuration) again at which stage the processing is resumed. You would choose this option for requirements such as sending a proactive notification for an upcoming appointment later in the week or month.
...
![Social Hour Check Node](https://files.readme.io/eb52008-Social.jpg)
...
![Screenshot of Social Hour Check Node Configuration Page](https://files.readme.io/a7c5974-Social_Hour_Check.jpg)
...
![Node Outcomes](https://files.readme.io/36c6db3-Social_Hour_Check1.jpg)
...
![Input and Custom Variables](https://files.readme.io/3ce7c82-Social_Hour_Check3.jpg)
...
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management-in-flows) are available for use in subsequent nodes. The following are the standard output variables for the Social Hour Check node:

- **socialHour.timeToNext** - . 



![Output Variables](https://files.readme.io/48e738f-Social_Hour_Check2.jpg)
...
| --- | --- |
| Success (green)  <br>  <br>**Note**: You can see this node edge only when you complete the node configuration. | \* **onSuccess** - the flow exits through this node when it is a success. |
| Timeout (yellow/amber) | \* **nextSocialHour** - the flow exits through this node outcome when the message originates outside the configured social hours. The flow then waits for the next social hour to deliver the message. |
| Error (red) | \* **onError** - the flow exits through this node outcome when there is an error |
|  | \* **notInSocialHour** -This branch is executed when the transaction occurs outside the time window specified for social interaction in the Social Hour node. |
...
![Node Outcomes](https://files.readme.io/4ef57e2-Social_Hour_Check1.jpg)
...
![Sample Configuration of Social Hours](https://files.readme.io/7d1df22-Social_Hour_Check4.jpg)
