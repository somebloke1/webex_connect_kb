...
> 📘 Note
> 
> The following Email App Configuration instructions are applicable only for Webex Contact Center and <<prodname>> integration. If you have a standalone <<prodname>> tenant please refer to [Email App](https://help.imiconnect.io/docs/email) configuration instructions available.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4b718fe-1.jpg",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7968bf5-2.jpg",
        "Gmail OAuth 2.0 for Outbound Emails.jpeg",
        "Screenshot of Selecting the Authentication Type."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of Selecting the Authentication Type."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2572978a536f981130312ad50212a65f304a59fc690213f2e461e3f7df490f2a-eu.webexconnect.io_apps_email-smtp_4.png",
        null,
        "Screenshot of Configuring New Email App."
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/eee8baa-3.jpg",
        "Picture 13.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a6b4df6-Email3.jpg",
        "Picture 14.png",
        "Screenshot of Adding the callback URL."
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/38b897d-4.jpg",
        "Picture 15.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f62aaf6-2.jpg",
        "Picture 16.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/07815f0e102d19cca6537aa60f6d4a2fff09890bd1505620bcc53f8f7f9c12a6-0948c81-image001.png",
        "",
...
1. Configure an Outbound Webhook in <<prodname>> under 'Assets->Integrations' to track incoming emails. This would require you to select the email channel asset configured newly in the Entity dropdown. Refer to [Outbound Webhooks](https://help.imiconnect.io/docs/outbound-webhooks) for more details.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e87ef22-5.jpg",
        "MO OAuth.jpg",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b2e4a48-WxCC_Email_Forward.jpg",
        "WxCC Email Forward.jpg",
        "Screenshot of Select Forward a copy of Incoming mail."
      ],
      "align": "center",
      "border": true,
      "caption": "Select Forward a copy of Incoming mail."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8cdcb87-Wxcc3.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1c5424e-Wxcc5.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/603bda2ad8c39f244931bf55329aa136aae8a73ffd9a55e37631c815608db385-Value_Image.png",
  ...
  "images": [
    {
      "image": [
        ...
        "Screenshot of API Permissions Page."
      ],
      "align": "center",
      "border": true,
      "caption": "Screenshot of API Permissions Page."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8d44fc80f19d0ea3867ee5a4eac4895586479ff2924d4ac138fc5e549ca6ca77-API_Permissions_1.png",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/65c28e8-Wxcc9.png",
        "Tenant ID SMTP.png",
...
4. Create an Email asset in <<prodname>> with above details.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2afdadd21178e4f6cc6c127cd22b258dd278c79a33d4f0e4628e156fff7d475b-staging.webexconnect.io_apps_email-smtp_17262.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c90e2b1-7.jpg",
...
5. Select the required service (Note: this should be the <<prodname>> service that would be used for configuring Email flows for Webex Contact Center integration)
6. Click **Register**. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/281087f-8.jpg",
        null,
