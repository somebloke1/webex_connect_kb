...
> 📘 SMS Routes
> 
> When you send outbound message requests to the <<prodname>> platform, we send it to the destination device through pre-configured SMS routes to ensure optimal delivery performance and latency.
> 
> Every <<prodname>> tenant has an SMS route configured based on various parameters. If a custom route has been configured for your tenant based on specific requirements, you will see an SMS Route dropdown option to select the preferred SMS route for the SMS traffic, sent via the concerned <<prodname>>Service. Please reach out to your account manager if you have any custom routing requirements.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/017653a-Locking_n_Deleting.jpg",
        "Locking, Deleting, and Other Settings Service Settings.png",
        "Screenshot of Webex Connect Service Settings"
      ],
      "align": "center",
      "border": true,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/99a9fb417d07a5ebaca1256a8bfa8cac1abd1dbdd5f94f09f8b715dc0a89029a-image-20250723-110826.png",
        "",
        "Fallback Wait Time when Branded Text is Enabled"
      ],
      "align": "center",
      "border": true,
      "caption": "Fallback Wait Time when Branded Text is Enabled"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/30509f4-delete_a_service.png",
        "",
        "Screenshot of Delete Service pop-up."
      ],
      "align": "center",
      "sizing": "400px",
      "border": true,
      "caption": "Screenshot of Delete Service pop-up"
    }
  ]
}
[/block]
