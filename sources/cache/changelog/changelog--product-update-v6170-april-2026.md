# Product Update - v6.17.0, April 2026

Source: https://help.webexconnect.io/changelog/product-update-v6170-april-2026
Documentation version: 6.20.0
Retrieved: 2026-09-08T23:31:53+00:00

Webex Connect v6.17.0 release brings multiple new capabilities to help you continue delivering seamless customer experiences.
...
Webex Connect now includes a new “Authentication Context Requirements” section in SSO Settings in Webex Connect. This allows Tenant Owners to choose which login methods are accepted during SSO, improving compatibility with Identity Providers that use MFA and other authentication methods, while keeping the default password-based login unchanged.
...
Meta has updated Messenger policy for messages sent beyond 24 hours from the customer’s last message. For such post-24-hour use cases, only the “HUMAN_AGENT” tag is supported. Other Messenger message tags are no longer supported for this scenario and may result in message failures. Webex Connect users using Messenger APIs and flows that rely on “non-HUMAN_AGENT” tags outside the 24-hour window should review and update them accordingly.
